...
- Harness: `archive/qa-scripts/nexus-sprint-m3-multi-turn-reasoning-flag-contract-harness.js`
- QA: `archive/qa-scripts/nexus-sprint-m3-multi-turn-reasoning-flag-contract-harness-qa.js`
