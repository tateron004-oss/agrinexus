...
Sprint A100-3 adds a safe-autonomy review contract for Agriculture Support.

Objective: Structures crop, pest, soil, weather, and extension questions into citation-ready advisory previews.
...
```text
npm run qa:nexus-a100-3-agriculture-support
```
