...
Sprint A100-38 adds a safe-autonomy review contract for Regional Deployment Readiness.

Objective: Summarizes regional rollout readiness for language, provider, map, and compliance boundaries.
...
```text
npm run qa:nexus-a100-38-regional-deployment-readiness
```
