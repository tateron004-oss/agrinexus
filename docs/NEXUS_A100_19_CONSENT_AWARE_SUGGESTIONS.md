...
Sprint A100-19 adds a safe-autonomy review contract for Consent-Aware Suggestions.

Objective: Creates suggestions that remain inert until the user explicitly chooses a safe action.
...
```text
npm run qa:nexus-a100-19-consent-aware-suggestions
```
