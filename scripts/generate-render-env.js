...
const shared = {
  ...
  AUTH0_DOMAIN: fromEnv("AUTH0_DOMAIN", ""),
  AUTH0_CLIENT_ID: fromEnv("AUTH0_CLIENT_ID", ""),
  AUTH0_CLIENT_SECRET: fromEnv("AUTH0_CLIENT_SECRET", ""),
  CLERK_SECRET_KEY: fromEnv("CLERK_SECRET_KEY", ""),
  EMAIL_PROVIDER: fromEnv("EMAIL_PROVIDER", "webhook"),
  EMAIL_WEBHOOK_URL: `${providerBase}/communications/email`,
  EMAIL_FROM: fromEnv("EMAIL_FROM", ""),
  RESEND_API_KEY: fromEnv("RESEND_API_KEY", ""),
  SENDGRID_API_KEY: fromEnv("SENDGRID_API_KEY", ""),
  MAILGUN_API_KEY: fromEnv("MAILGUN_API_KEY", ""),
  ...
  VOICE_REALTIME_PROVIDER: fromEnv("VOICE_REALTIME_PROVIDER", "openai"),
  OPENAI_REALTIME_MODEL: fromEnv("OPENAI_REALTIME_MODEL", "gpt-realtime-2"),
  OPENAI_REALTIME_VOICE: fromEnv("OPENAI_REALTIME_VOICE", "marin"),
  OPENAI_REALTIME_TRANSCRIBE_MODEL: fromEnv("OPENAI_REALTIME_TRANSCRIBE_MODEL", "gpt-realtime-whisper"),
  OPENAI_REALTIME_TRANSLATION_MODEL: fromEnv("OPENAI_REALTIME_TRANSLATION_MODEL", "gpt-realtime-translate"),
  ...
  LOGISTICS_TRACKING_PROVIDER: fromEnv("LOGISTICS_TRACKING_PROVIDER", "webhook"),
  LOGISTICS_TRACKING_URL: fromEnv("LOGISTICS_TRACKING_URL", `${providerBase}/trade/logistics`),
  LOGISTICS_TRACKING_API_KEY: fromEnv("LOGISTICS_TRACKING_API_KEY", ""),
  LOGISTICS_TRACKING_TIMEOUT_MS: fromEnv("LOGISTICS_TRACKING_TIMEOUT_MS", "5000"),
...
const providerOnly = {
  ...
  VOICE_REALTIME_PROVIDER: shared.VOICE_REALTIME_PROVIDER,
  OPENAI_REALTIME_MODEL: shared.OPENAI_REALTIME_MODEL,
  OPENAI_REALTIME_VOICE: shared.OPENAI_REALTIME_VOICE,
  MAPBOX_ACCESS_TOKEN: shared.MAPBOX_ACCESS_TOKEN,
  OPENROUTESERVICE_API_KEY: shared.OPENROUTESERVICE_API_KEY,
  GOOGLE_MAPS_API_KEY: shared.GOOGLE_MAPS_API_KEY,
  MOODLE_BASE_URL: shared.MOODLE_BASE_URL,
  MOODLE_TOKEN: shared.MOODLE_TOKEN,
  OPENEDX_BASE_URL: shared.OPENEDX_BASE_URL,
  OPENEDX_API_KEY: shared.OPENEDX_API_KEY,
  ADZUNA_APP_ID: shared.ADZUNA_APP_ID,
  ADZUNA_APP_KEY: shared.ADZUNA_APP_KEY,
  OPENMRS_BASE_URL: shared.OPENMRS_BASE_URL,
  OPENMRS_TOKEN: shared.OPENMRS_TOKEN,
  PAYSTACK_SECRET_KEY: shared.PAYSTACK_SECRET_KEY,
  FLUTTERWAVE_SECRET_KEY: shared.FLUTTERWAVE_SECRET_KEY,
  LOGISTICS_TRACKING_URL: shared.LOGISTICS_TRACKING_URL,
  LOGISTICS_TRACKING_API_KEY: shared.LOGISTICS_TRACKING_API_KEY,
  SENTINEL_HUB_CLIENT_ID: shared.SENTINEL_HUB_CLIENT_ID,
  SENTINEL_HUB_CLIENT_SECRET: shared.SENTINEL_HUB_CLIENT_SECRET,
  RESEND_API_KEY: shared.RESEND_API_KEY,
  SENDGRID_API_KEY: shared.SENDGRID_API_KEY,
