...
const shared = {
  ...
  OPENAI_TTS_VOICE: fromEnv("OPENAI_TTS_VOICE", "cedar"),
  OPENAI_TTS_INSTRUCTIONS: fromEnv("OPENAI_TTS_INSTRUCTIONS", "Speak clearly, warmly, and slowly enough for rural field use."),
