...
[
  ...
  "Enrollment Gate",
  "Application Gate",
  "Profile Sharing Gate",
  "Training Review Queue",
  "Nexus, check learning enrollment readiness.",
  "Nexus, check job application readiness.",
  "Nexus, check profile sharing readiness.",
  "Nexus, queue training workforce review.",
  "data-testid=\"nexus-training-workforce-sections-gates\"",
  "will not enroll a learner, submit a job application, contact an employer, issue credentials, share a profile, or schedule an interview",
  "training_support_packet",
  "workforce_pathway_packet",
  "employer_partner_research_packet",
  "learning_recommendation_packet"
