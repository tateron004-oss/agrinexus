...
const build = "nexus-behavior-510";
const cache = "agrinexus-pwa-v455";
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-510"), "microphone button must exist before app.js executes");
