...
const build = "nexus-behavior-500";
const cache = "agrinexus-pwa-v445";
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-500"), "microphone button must exist before app.js executes");
