...
const build = "nexus-behavior-488";
const cache = "agrinexus-pwa-v433";
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-488"), "microphone button must exist before app.js executes");
