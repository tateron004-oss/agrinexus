...
const build = "nexus-behavior-494";
const cache = "agrinexus-pwa-v439";
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-494"), "microphone button must exist before app.js executes");
