...
const build = "nexus-behavior-504";
const cache = "agrinexus-pwa-v449";
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-504"), "microphone button must exist before app.js executes");
