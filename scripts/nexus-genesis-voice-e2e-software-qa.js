...
const build = "nexus-behavior-505";
const cache = "agrinexus-pwa-v450";
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-505"), "microphone button must exist before app.js executes");
