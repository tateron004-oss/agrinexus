...
const build = "nexus-behavior-477";
const cache = "agrinexus-pwa-v422";
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-477"), "microphone button must exist before app.js executes");
