...
const build = "nexus-behavior-476";
const cache = "agrinexus-pwa-v421";
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-476"), "microphone button must exist before app.js executes");
