...
const build = "nexus-behavior-503";
const cache = "agrinexus-pwa-v448";
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-503"), "microphone button must exist before app.js executes");
