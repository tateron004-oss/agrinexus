...
const build = "nexus-behavior-501";
const cache = "agrinexus-pwa-v446";
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-501"), "microphone button must exist before app.js executes");
