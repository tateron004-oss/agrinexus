...
const build = "nexus-behavior-475";
const cache = "agrinexus-pwa-v420";
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-475"), "microphone button must exist before app.js executes");
