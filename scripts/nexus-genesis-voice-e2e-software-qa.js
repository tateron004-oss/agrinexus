...
const build = "nexus-behavior-493";
const cache = "agrinexus-pwa-v438";
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-493"), "microphone button must exist before app.js executes");
