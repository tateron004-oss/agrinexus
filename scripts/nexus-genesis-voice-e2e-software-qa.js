...
const build = "nexus-behavior-478";
const cache = "agrinexus-pwa-v423";
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-478"), "microphone button must exist before app.js executes");
