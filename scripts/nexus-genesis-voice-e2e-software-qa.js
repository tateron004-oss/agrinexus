...
const build = "nexus-behavior-491";
const cache = "agrinexus-pwa-v436";
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-491"), "microphone button must exist before app.js executes");
