...
const build = "nexus-behavior-492";
const cache = "agrinexus-pwa-v437";
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-492"), "microphone button must exist before app.js executes");
