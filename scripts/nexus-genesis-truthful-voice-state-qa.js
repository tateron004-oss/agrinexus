...
includesAll(app, [
  'AGRINEXUS_BUILD_VERSION = "nexus-behavior-447"',
  'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v392"',
  'NEXUS_GENESIS_VOICE_RUNTIME_VERSION = "nexus-genesis-voice-runtime-v447"'
], "app build");
includesAll(index, [
  "/manifest.webmanifest?v=nexus-behavior-447",
  "/styles.css?v=nexus-behavior-447",
  "/app.js?v=nexus-behavior-447"
], "index build");
includesAll(server, [
  'AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-447"',
  'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v392"'
], "server build");
includesAll(sw, [
  'CACHE_NAME = "agrinexus-pwa-v392"',
  'BUILD_VERSION = "nexus-behavior-447"'
