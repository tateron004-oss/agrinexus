...
includesAll(app, [
  'AGRINEXUS_BUILD_VERSION = "nexus-behavior-438"',
  'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v383"',
  'NEXUS_GENESIS_VOICE_RUNTIME_VERSION = "nexus-genesis-voice-runtime-v438"'
], "app build");
includesAll(index, [
  "/manifest.webmanifest?v=nexus-behavior-438",
  "/styles.css?v=nexus-behavior-438",
  "/app.js?v=nexus-behavior-438"
], "index build");
includesAll(server, [
  'AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-438"',
  'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v383"'
], "server build");
includesAll(sw, [
  'CACHE_NAME = "agrinexus-pwa-v383"',
  'BUILD_VERSION = "nexus-behavior-438"'
