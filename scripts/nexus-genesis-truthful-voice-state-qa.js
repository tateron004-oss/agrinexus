...
includesAll(app, [
  'AGRINEXUS_BUILD_VERSION = "nexus-behavior-492"',
  'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v437"',
  'NEXUS_GENESIS_VOICE_RUNTIME_VERSION = "nexus-genesis-voice-runtime-v456"'
], "app build");
includesAll(index, [
  "/manifest.webmanifest?v=nexus-behavior-492",
  "/styles.css?v=nexus-behavior-492",
  "/app.js?v=nexus-behavior-492"
], "index build");
includesAll(server, [
  'AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-492"',
  'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v437"'
], "server build");
includesAll(sw, [
  'CACHE_NAME = "agrinexus-pwa-v437"',
  'BUILD_VERSION = "nexus-behavior-492"'
