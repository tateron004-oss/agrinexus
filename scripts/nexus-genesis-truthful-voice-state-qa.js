...
includesAll(app, [
  'AGRINEXUS_BUILD_VERSION = "nexus-behavior-446"',
  'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v391"',
  'NEXUS_GENESIS_VOICE_RUNTIME_VERSION = "nexus-genesis-voice-runtime-v446"'
], "app build");
includesAll(index, [
  "/manifest.webmanifest?v=nexus-behavior-446",
  "/styles.css?v=nexus-behavior-446",
  "/app.js?v=nexus-behavior-446"
], "index build");
includesAll(server, [
  'AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-446"',
  'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v391"'
], "server build");
includesAll(sw, [
  'CACHE_NAME = "agrinexus-pwa-v391"',
  'BUILD_VERSION = "nexus-behavior-446"'
