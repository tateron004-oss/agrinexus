...
includesAll(app, [
  'AGRINEXUS_BUILD_VERSION = "nexus-behavior-491"',
  'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v436"',
  'NEXUS_GENESIS_VOICE_RUNTIME_VERSION = "nexus-genesis-voice-runtime-v456"'
], "app build");
includesAll(index, [
  "/manifest.webmanifest?v=nexus-behavior-491",
  "/styles.css?v=nexus-behavior-491",
  "/app.js?v=nexus-behavior-491"
], "index build");
includesAll(server, [
  'AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-491"',
  'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v436"'
], "server build");
includesAll(sw, [
  'CACHE_NAME = "agrinexus-pwa-v436"',
  'BUILD_VERSION = "nexus-behavior-491"'
