...
const checks = [
  ...
  { prompt: "I need medicine.", intent: "conversation.medicine_help", section: "health", includes: "Yes, I can help with medicine access" },
  { prompt: "Nexus, I need medicine.", intent: "conversation.medicine_help", section: "health", includes: "Yes, I can help with medicine access" },
  { prompt: "I want medicine.", intent: "conversation.medicine_help", section: "health", includes: "Yes, I can help with medicine access" },
  { prompt: "medicine need", intent: "conversation.medicine_help", section: "health", includes: "Yes, I can help with medicine access" },
  { prompt: "dawa", intent: "conversation.medicine_help", section: "health", includes: "Yes, I can help with medicine access" },
  { prompt: "necesito medicina", intent: "conversation.medicine_help", section: "health", includes: "Yes, I can help with medicine access" },
  ...
  { prompt: "Nexus, show clinic and pharmacy on the map.", intent: "conversation.clinic_map_help", section: "map", includes: "clinic or pharmacy support on the map" },
