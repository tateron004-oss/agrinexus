...
const checks = [
  ...
  { prompt: "Explain AgriNexus.", intent: "conversation.platform_explained", section: "agent", includes: "Nexus is the assistant inside Nexus Genesis | AgriNexus" },
  { prompt: "explain agrinexus", intent: "conversation.platform_explained", section: "agent", includes: "Nexus is the assistant inside Nexus Genesis | AgriNexus" },
  { prompt: "Nexus, explain AgriNexus.", intent: "conversation.platform_explained", section: "agent", includes: "Nexus is the assistant inside Nexus Genesis | AgriNexus" },
  { prompt: "Can you explain AgriNexus?", intent: "conversation.platform_explained", section: "agent", includes: "Nexus is the assistant inside Nexus Genesis | AgriNexus" },
  { prompt: "Tell me what AgriNexus is.", intent: "conversation.platform_explained", section: "agent", includes: "Nexus is the assistant inside Nexus Genesis | AgriNexus" },
  { prompt: "What is AgriNexus?", intent: "conversation.platform_explained", section: "agent", includes: "Nexus is the assistant inside Nexus Genesis | AgriNexus" },
