...
const checks = [
  ...
  { prompt: "Find me a clinic.", intent: "conversation.clinic_map_help", section: "map", includes: "First, tell me" },
  { prompt: "clinic near", intent: "conversation.clinic_map_help", section: "map", includes: "First, tell me" },
  { prompt: "clinica cerca", intent: "conversation.clinic_map_help", section: "map", includes: "First, tell me" },
  { prompt: "kliniki karibu", intent: "conversation.clinic_map_help", section: "map", includes: "First, tell me" },
  ...
  { prompt: "Nexus, call a provider.", intent: "conversation.doctor_help", section: "health", includes: "not a diagnosis" },
  { prompt: "Nexus, start intake.", intent: "conversation.health_intake", section: "health", includes: "not a diagnosis" },
  { prompt: "Nexus, start health intake.", intent: "conversation.health_intake", section: "health", includes: "not a diagnosis" },
  ...
  { prompt: "Nexus, I cannot read. Help me with health intake.", intent: "conversation.health_intake", section: "health", includes: "not a diagnosis" },
  ...
  { prompt: "Nexus, complete my lesson.", intent: "learning.lesson_progress", section: "learning", includes: "Lesson progress" },
  { prompt: "Nexus, issue my certificate.", intent: "learning.certificate", section: "learning", includes: "Certificate workflow" },
  ...
  { prompt: "Nexus, show clinic and pharmacy on the map.", intent: "conversation.clinic_map_help", section: "map", includes: "First, tell me" },
  { prompt: "Nexus, track route from farm to market.", intent: "map.live_route_tracking", section: "map", includes: "farm-to-market route" },
  { prompt: "Nexus, what is the weather in Nairobi?", intent: "conversation.daily_life_advisor", section: "health", includes: "Nairobi" },
  ...
  { prompt: "Nexus, run live service check.", intent: "production.live_service_check", section: "integrations", includes: "Live service check" },
  { prompt: "Nexus, explain provider readiness.", intent: "production.provider_readiness", section: "integrations", includes: "Provider readiness" },
  ...
  { prompt: "Nexus, send SMS to the buyer.", intent: "communications.sms_buyer_ready", section: "trade", includes: "SMS to the buyer" },
  { prompt: "Nexus, send WhatsApp to the seller.", intent: "communications.whatsapp_seller_ready", section: "trade", includes: "WhatsApp to the seller" },
