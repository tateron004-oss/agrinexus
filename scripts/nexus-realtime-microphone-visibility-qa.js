...
const checks = [
  [
    ...
    app.includes('const AGRINEXUS_BUILD_VERSION = "nexus-behavior-477"') &&
      app.includes('const AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v422"') &&
      server.includes('const AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-477"') &&
      sw.includes('const CACHE_NAME = "agrinexus-pwa-v422"') &&
      index.includes("/app.js?v=nexus-behavior-477")
  ],
  [
    ...
    index.includes('id="nexusPermanentMicrophoneDock"') &&
      ...
      index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf('/app.js?v=nexus-behavior-477') &&
