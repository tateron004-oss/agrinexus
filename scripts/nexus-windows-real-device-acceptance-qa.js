...
assert.match(spec, /microphone-startup-failure\.json/);
assert.match(spec, /NexusGenesisVoiceLifecycleDiagnostics/);
assert.match(spec, /nexusVoiceAudioPipeline/);
assert.match(spec, /navigator\.permissions\.query/);
...
assert.match(spec, /await connectRealtime\(page,\s*browserConsole\);[\s\S]*Nexus physical microphone calibration\./);
