...
const singleTurnCases = [
  ...
  c("core", "what can you do", ["conversation.capability_summary"], "agent", ["listen in normal words"]),
  c("core", "what can do", ["conversation.capability_summary"], "agent", ["listen in normal words"]),
