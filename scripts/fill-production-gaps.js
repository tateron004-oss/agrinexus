...
const values = {
  ...
  OPENAI_TTS_VOICE: existing.OPENAI_TTS_VOICE || "cedar",
  OPENAI_TTS_INSTRUCTIONS: existing.OPENAI_TTS_INSTRUCTIONS || "Speak clearly, warmly, and slowly enough for rural field use.",
