...
assert(hero.includes("Type to Nexus"), "typed entry label is explicit");
assert(hero.includes('data-nexus-primary-typed-entry="true"'), "typed entry has stable marker");
assert(hero.includes('aria-describedby="nexusCommandTypedHint"'), "typed entry has hint relationship");
assert(hero.includes("Tell Nexus what you need help with."), "typed placeholder is conversational");
assert(hero.includes('data-nexus-primary-typed-submit="true"'), "typed submit has stable marker");
assert(hero.includes('data-nexus-command-center-submit'), "typed submit uses existing command-center submit route");
assert(hero.includes('data-nexus-command-input-target="nexusCommandCenterInput"'), "typed submit targets the primary command input");
assert(hero.includes("Press Enter to ask. Use Shift+Enter for a new line."), "typed keyboard hint is visible");
