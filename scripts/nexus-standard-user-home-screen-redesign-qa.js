...
[
  [app, 'AGRINEXUS_BUILD_VERSION = "nexus-behavior-487"', "app build version"],
  [app, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v432"', "app cache version"],
  [server, 'AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-487"', "server build version"],
  [server, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v432"', "server cache version"],
  [sw, 'CACHE_NAME = "agrinexus-pwa-v432"', "service worker cache"],
  [sw, 'BUILD_VERSION = "nexus-behavior-487"', "service worker build"],
  [index, "/styles.css?v=nexus-behavior-487", "stylesheet cache bust"],
  [index, "/app.js?v=nexus-behavior-487", "app script cache bust"]
