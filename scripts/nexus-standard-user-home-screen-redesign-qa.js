...
[
  [app, 'AGRINEXUS_BUILD_VERSION = "nexus-behavior-425"', "app build version"],
  [app, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v370"', "app cache version"],
  [server, 'AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-425"', "server build version"],
  ...
  [sw, 'BUILD_VERSION = "nexus-behavior-425"', "service worker build"],
  [index, "/styles.css?v=nexus-behavior-425", "stylesheet cache bust"],
  [index, "/app.js?v=nexus-behavior-425", "app script cache bust"]
