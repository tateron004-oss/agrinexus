...
[
  [app, 'AGRINEXUS_BUILD_VERSION = "nexus-behavior-423"', "app build version"],
  [app, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v370"', "app cache version"],
  [server, 'AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-423"', "server build version"],
  ...
  [sw, 'BUILD_VERSION = "nexus-behavior-423"', "service worker build"],
  [index, "/styles.css?v=nexus-behavior-423", "stylesheet cache bust"],
  [index, "/app.js?v=nexus-behavior-423", "app script cache bust"]
