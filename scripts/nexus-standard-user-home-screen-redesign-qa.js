...
[
  [app, 'AGRINEXUS_BUILD_VERSION = "__NEXUS_RELEASE_SHA__"', "app build version"],
  [app, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-__NEXUS_RELEASE_SHA__"', "app cache version"],
  [server, "AGRINEXUS_WEB_BUILD_VERSION = NEXUS_EFFECTIVE_RELEASE_SHA", "server build version"],
  [server, "AGRINEXUS_PWA_CACHE_VERSION = `agrinexus-pwa-${NEXUS_EFFECTIVE_RELEASE_SHA}`", "server cache version"],
  [sw, 'CACHE_NAME = "agrinexus-pwa-__NEXUS_RELEASE_SHA__"', "service worker cache"],
  [sw, 'BUILD_VERSION = "__NEXUS_RELEASE_SHA__"', "service worker build"],
  [index, "/styles.css?v=__NEXUS_RELEASE_SHA__", "stylesheet cache bust"],
  [index, "/app.js?v=__NEXUS_RELEASE_SHA__", "app script cache bust"]
