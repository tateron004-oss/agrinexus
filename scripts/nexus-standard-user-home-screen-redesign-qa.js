...
[
  [app, 'AGRINEXUS_BUILD_VERSION = "nexus-behavior-404"', "app build version"],
  [app, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v356"', "app cache version"],
  [server, 'AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-404"', "server build version"],
  ...
  [sw, 'BUILD_VERSION = "nexus-behavior-404"', "service worker build"],
  [index, "/styles.css?v=nexus-behavior-404", "stylesheet cache bust"],
  [index, "/app.js?v=nexus-behavior-404", "app script cache bust"]
