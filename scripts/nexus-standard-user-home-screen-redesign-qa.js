...
[
  [app, 'AGRINEXUS_BUILD_VERSION = "nexus-behavior-360"', "app build version"],
  [app, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v339"', "app cache version"],
  [server, 'AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-360"', "server build version"],
  ...
  [sw, 'BUILD_VERSION = "nexus-behavior-360"', "service worker build"],
  [index, "/styles.css?v=nexus-behavior-360", "stylesheet cache bust"],
  [index, "/app.js?v=nexus-behavior-360", "app script cache bust"]
