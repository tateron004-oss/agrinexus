...
[
  [app, 'AGRINEXUS_BUILD_VERSION = "nexus-behavior-488"', "app build version"],
  [app, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v433"', "app cache version"],
  [server, 'AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-488"', "server build version"],
  [server, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v433"', "server cache version"],
  [sw, 'CACHE_NAME = "agrinexus-pwa-v433"', "service worker cache"],
  [sw, 'BUILD_VERSION = "nexus-behavior-488"', "service worker build"],
  [index, "/styles.css?v=nexus-behavior-488", "stylesheet cache bust"],
  [index, "/app.js?v=nexus-behavior-488", "app script cache bust"]
