...
assert.match(observeBody, /lowRiskSuggestion,[\s\S]{0,260}controlledActionMetadata/, "observation record may store low-risk Level 1 suggestion label metadata and controlled action metadata");
