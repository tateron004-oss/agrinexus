...
assert(app.includes("if (handleJarvisStyleStandardUserSafetyResponse(command)) return;\n        void handleVoiceCommand(command);"), "caption Send should use Jarvis-style handling before handleVoiceCommand");
assert(app.includes("if (handleJarvisStyleStandardUserSafetyResponse(command)) return;\n      void handleVoiceCommand(command);"), "caption Enter should use Jarvis-style handling before handleVoiceCommand");
