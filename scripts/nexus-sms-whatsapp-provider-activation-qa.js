...
assert(server.includes("const recipient = configuredOwnerRecipient || contact.to"), "Realtime communications must use the private configured owner number instead of treating its spoken alias as a phone number");
