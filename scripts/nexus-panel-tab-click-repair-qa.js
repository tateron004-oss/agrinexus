...
[
  ["nexus-behavior-383", "app build version", "server build version"],
...
includes(sw, 'BUILD_VERSION = "nexus-behavior-383"', "service worker build bump");
includes(index, "/styles.css?v=nexus-behavior-383", "stylesheet cache bust");
includes(index, "/app.js?v=nexus-behavior-383", "app cache bust");
