...
[
  ["nexus-behavior-392", "app build version", "server build version"],
...
includes(sw, 'BUILD_VERSION = "nexus-behavior-392"', "service worker build bump");
includes(index, "/styles.css?v=nexus-behavior-392", "stylesheet cache bust");
includes(index, "/app.js?v=nexus-behavior-392", "app cache bust");
