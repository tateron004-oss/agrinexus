...
[
  ["nexus-behavior-390", "app build version", "server build version"],
...
includes(sw, 'BUILD_VERSION = "nexus-behavior-390"', "service worker build bump");
includes(index, "/styles.css?v=nexus-behavior-390", "stylesheet cache bust");
includes(index, "/app.js?v=nexus-behavior-390", "app cache bust");
