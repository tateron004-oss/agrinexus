...
[
  ["nexus-behavior-382", "app build version", "server build version"],
...
includes(sw, 'BUILD_VERSION = "nexus-behavior-382"', "service worker build bump");
includes(index, "/styles.css?v=nexus-behavior-382", "stylesheet cache bust");
includes(index, "/app.js?v=nexus-behavior-382", "app cache bust");
