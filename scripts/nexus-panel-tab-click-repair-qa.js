...
[
  ["nexus-behavior-395", "app build version", "server build version"],
...
includes(sw, 'BUILD_VERSION = "nexus-behavior-395"', "service worker build bump");
includes(index, "/styles.css?v=nexus-behavior-395", "stylesheet cache bust");
includes(index, "/app.js?v=nexus-behavior-395", "app cache bust");
