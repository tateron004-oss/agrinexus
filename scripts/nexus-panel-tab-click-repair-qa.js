...
[
  ["nexus-behavior-425", "app build version", "server build version"],
...
includes(sw, 'BUILD_VERSION = "nexus-behavior-425"', "service worker build bump");
includes(index, "/styles.css?v=nexus-behavior-425", "stylesheet cache bust");
includes(index, "/app.js?v=nexus-behavior-425", "app cache bust");
