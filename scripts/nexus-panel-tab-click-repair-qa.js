...
[
  ["nexus-behavior-393", "app build version", "server build version"],
...
includes(sw, 'BUILD_VERSION = "nexus-behavior-393"', "service worker build bump");
includes(index, "/styles.css?v=nexus-behavior-393", "stylesheet cache bust");
includes(index, "/app.js?v=nexus-behavior-393", "app cache bust");
