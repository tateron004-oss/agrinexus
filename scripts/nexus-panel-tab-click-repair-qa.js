...
[
  ["nexus-behavior-404", "app build version", "server build version"],
...
includes(sw, 'BUILD_VERSION = "nexus-behavior-404"', "service worker build bump");
includes(index, "/styles.css?v=nexus-behavior-404", "stylesheet cache bust");
includes(index, "/app.js?v=nexus-behavior-404", "app cache bust");
