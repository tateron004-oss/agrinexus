...
[
  ["nexus-behavior-394", "app build version", "server build version"],
...
includes(sw, 'BUILD_VERSION = "nexus-behavior-394"', "service worker build bump");
includes(index, "/styles.css?v=nexus-behavior-394", "stylesheet cache bust");
includes(index, "/app.js?v=nexus-behavior-394", "app cache bust");
