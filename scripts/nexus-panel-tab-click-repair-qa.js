...
includes(sw, 'BUILD_VERSION = "nexus-behavior-360"', "service worker build bump");
includes(index, "/styles.css?v=nexus-behavior-360", "stylesheet cache bust");
includes(index, "/app.js?v=nexus-behavior-360", "app cache bust");
