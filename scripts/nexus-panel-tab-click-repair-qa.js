...
[
  ["nexus-behavior-388", "app build version", "server build version"],
...
includes(sw, 'BUILD_VERSION = "nexus-behavior-388"', "service worker build bump");
includes(index, "/styles.css?v=nexus-behavior-388", "stylesheet cache bust");
includes(index, "/app.js?v=nexus-behavior-388", "app cache bust");
