...
[
  ["nexus-behavior-405", "app build version", "server build version"],
...
includes(sw, 'BUILD_VERSION = "nexus-behavior-405"', "service worker build bump");
includes(index, "/styles.css?v=nexus-behavior-405", "stylesheet cache bust");
includes(index, "/app.js?v=nexus-behavior-405", "app cache bust");
