...
const stages = [
  ...
  { id: 'integrated-safe', command: '$env:NEXUS_OPENAI_NATIVE_ENABLED="false"; npm.cmd run qa:all-safe' }
];
function hashSource() {
  const hash = crypto.createHash('sha256');
  const files = ['server.js', 'public/app.js', 'public/sw.js', 'package.json', 'scripts/qa-suite.js', 'scripts/nexus-production-layer-activation-integration-qa.js', 'scripts/nexus-openai-native-genesis-qa.js', 'scripts/nexus-openai-native-tool-parity-qa.js', 'scripts/voice-phase2-language-qa.js', 'scripts/voice-phase3-tts-qa.js', 'scripts/phone-greeting-qa.js'];
