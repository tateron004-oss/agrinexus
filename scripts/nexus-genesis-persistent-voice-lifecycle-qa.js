...
["nexus-behavior-509", "agrinexus-pwa-v454"].forEach(marker => {
...
includes(index, "nexus-behavior-509", "index behavior marker nexus-behavior-509");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-509"), "microphone button must appear before app.js");
