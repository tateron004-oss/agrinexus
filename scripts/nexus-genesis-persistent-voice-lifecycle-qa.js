...
["nexus-behavior-505", "agrinexus-pwa-v450"].forEach(marker => {
...
includes(index, "nexus-behavior-505", "index behavior marker nexus-behavior-505");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-505"), "microphone button must appear before app.js");
