...
["nexus-behavior-503", "agrinexus-pwa-v448"].forEach(marker => {
...
includes(index, "nexus-behavior-503", "index behavior marker nexus-behavior-503");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-503"), "microphone button must appear before app.js");
