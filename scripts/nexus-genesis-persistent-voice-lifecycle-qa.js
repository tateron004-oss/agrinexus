...
["nexus-behavior-501", "agrinexus-pwa-v446"].forEach(marker => {
...
includes(index, "nexus-behavior-501", "index behavior marker nexus-behavior-501");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-501"), "microphone button must appear before app.js");
