...
["nexus-behavior-477", "agrinexus-pwa-v422"].forEach(marker => {
...
includes(index, "nexus-behavior-477", "index behavior marker nexus-behavior-477");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-477"), "microphone button must appear before app.js");
