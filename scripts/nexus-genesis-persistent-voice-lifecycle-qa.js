...
["nexus-behavior-512", "agrinexus-pwa-v457"].forEach(marker => {
...
includes(index, "nexus-behavior-512", "index behavior marker nexus-behavior-512");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-512"), "microphone button must appear before app.js");
