...
includes(index, "nexus-behavior-478", "index behavior marker nexus-behavior-478");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-478"), "microphone button must appear before app.js");
