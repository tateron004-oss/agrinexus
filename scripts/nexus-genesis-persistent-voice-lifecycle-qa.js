...
["nexus-behavior-494", "agrinexus-pwa-v439"].forEach(marker => {
...
includes(index, "nexus-behavior-494", "index behavior marker nexus-behavior-494");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-494"), "microphone button must appear before app.js");
