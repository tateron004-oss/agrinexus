...
["nexus-behavior-482", "agrinexus-pwa-v427"].forEach(marker => {
...
includes(index, "nexus-behavior-482", "index behavior marker nexus-behavior-482");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-482"), "microphone button must appear before app.js");
