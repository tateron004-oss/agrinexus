...
includes(index, "nexus-behavior-486", "index behavior marker nexus-behavior-486");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-486"), "microphone button must appear before app.js");
