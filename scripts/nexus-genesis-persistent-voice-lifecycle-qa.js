...
["nexus-behavior-508", "agrinexus-pwa-v453"].forEach(marker => {
...
includes(index, "nexus-behavior-508", "index behavior marker nexus-behavior-508");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-508"), "microphone button must appear before app.js");
