...
["nexus-behavior-483", "agrinexus-pwa-v428"].forEach(marker => {
...
includes(index, "nexus-behavior-483", "index behavior marker nexus-behavior-483");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-483"), "microphone button must appear before app.js");
