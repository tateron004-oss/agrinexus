...
includes(index, "nexus-behavior-510", "index behavior marker nexus-behavior-510");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-510"), "microphone button must appear before app.js");
