...
["nexus-behavior-490", "agrinexus-pwa-v435"].forEach(marker => {
...
includes(index, "nexus-behavior-490", "index behavior marker nexus-behavior-490");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-490"), "microphone button must appear before app.js");
