...
["nexus-behavior-507", "agrinexus-pwa-v452"].forEach(marker => {
...
includes(index, "nexus-behavior-507", "index behavior marker nexus-behavior-507");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-507"), "microphone button must appear before app.js");
