...
["nexus-behavior-504", "agrinexus-pwa-v449"].forEach(marker => {
...
includes(index, "nexus-behavior-504", "index behavior marker nexus-behavior-504");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-504"), "microphone button must appear before app.js");
