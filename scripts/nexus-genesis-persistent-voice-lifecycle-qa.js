...
["nexus-behavior-506", "agrinexus-pwa-v451"].forEach(marker => {
...
includes(index, "nexus-behavior-506", "index behavior marker nexus-behavior-506");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-506"), "microphone button must appear before app.js");
