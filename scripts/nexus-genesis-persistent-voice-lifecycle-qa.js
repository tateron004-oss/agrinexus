...
["nexus-behavior-491", "agrinexus-pwa-v436"].forEach(marker => {
...
includes(index, "nexus-behavior-491", "index behavior marker nexus-behavior-491");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-491"), "microphone button must appear before app.js");
