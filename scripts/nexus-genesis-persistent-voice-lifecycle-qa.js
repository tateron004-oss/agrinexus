...
["nexus-behavior-489", "agrinexus-pwa-v434"].forEach(marker => {
...
includes(index, "nexus-behavior-489", "index behavior marker nexus-behavior-489");
...
assert(index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf("/app.js?v=nexus-behavior-489"), "microphone button must appear before app.js");
