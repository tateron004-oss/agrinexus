...
includesAll(index, ["/app.js?v=nexus-behavior-506", "/styles.css?v=nexus-behavior-506"], "index cache");
includesAll(app, ["nexus-behavior-506", "agrinexus-pwa-v451", "nexus-genesis-voice-runtime-v456"], "app cache");
includesAll(server, ["nexus-behavior-506", "agrinexus-pwa-v451"], "server cache");
includesAll(sw, ["nexus-behavior-506", "agrinexus-pwa-v451"], "service worker cache");
