...
includesAll(index, ["/app.js?v=nexus-behavior-511", "/styles.css?v=nexus-behavior-511"], "index cache");
includesAll(app, ["nexus-behavior-511", "agrinexus-pwa-v456", "nexus-genesis-voice-runtime-v457"], "app cache");
includesAll(server, ["nexus-behavior-511", "agrinexus-pwa-v456"], "server cache");
includesAll(sw, ["nexus-behavior-511", "agrinexus-pwa-v456"], "service worker cache");
