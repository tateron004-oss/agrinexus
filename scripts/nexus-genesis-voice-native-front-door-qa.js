...
includesAll(index, ["/app.js?v=nexus-behavior-458", "/styles.css?v=nexus-behavior-458"], "index cache");
includesAll(app, ["nexus-behavior-458", "agrinexus-pwa-v403", "nexus-genesis-voice-runtime-v455"], "app cache");
includesAll(server, ["nexus-behavior-458", "agrinexus-pwa-v403"], "server cache");
includesAll(sw, ["nexus-behavior-458", "agrinexus-pwa-v403"], "service worker cache");
