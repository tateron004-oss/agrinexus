...
includesAll(index, ["/app.js?v=nexus-behavior-450", "/styles.css?v=nexus-behavior-450"], "index cache");
includesAll(app, ["nexus-behavior-450", "agrinexus-pwa-v395", "nexus-genesis-voice-runtime-v450"], "app cache");
includesAll(server, ["nexus-behavior-450", "agrinexus-pwa-v395"], "server cache");
includesAll(sw, ["nexus-behavior-450", "agrinexus-pwa-v395"], "service worker cache");
