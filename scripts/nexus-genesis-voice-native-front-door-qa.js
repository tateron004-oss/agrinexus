...
includesAll(index, ["/app.js?v=nexus-behavior-505", "/styles.css?v=nexus-behavior-505"], "index cache");
includesAll(app, ["nexus-behavior-505", "agrinexus-pwa-v450", "nexus-genesis-voice-runtime-v456"], "app cache");
includesAll(server, ["nexus-behavior-505", "agrinexus-pwa-v450"], "server cache");
includesAll(sw, ["nexus-behavior-505", "agrinexus-pwa-v450"], "service worker cache");
