...
includesAll(index, ["/app.js?v=nexus-behavior-449", "/styles.css?v=nexus-behavior-449"], "index cache");
includesAll(app, ["nexus-behavior-449", "agrinexus-pwa-v394", "nexus-genesis-voice-runtime-v449"], "app cache");
includesAll(server, ["nexus-behavior-449", "agrinexus-pwa-v394"], "server cache");
includesAll(sw, ["nexus-behavior-449", "agrinexus-pwa-v394"], "service worker cache");
