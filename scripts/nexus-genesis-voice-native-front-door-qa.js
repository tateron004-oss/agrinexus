...
includesAll(index, ["/app.js?v=nexus-behavior-437", "/styles.css?v=nexus-behavior-437"], "index cache");
includesAll(app, ["nexus-behavior-437", "agrinexus-pwa-v382", "nexus-genesis-voice-runtime-v437"], "app cache");
includesAll(server, ["nexus-behavior-437", "agrinexus-pwa-v382"], "server cache");
includesAll(sw, ["nexus-behavior-437", "agrinexus-pwa-v382"], "service worker cache");
