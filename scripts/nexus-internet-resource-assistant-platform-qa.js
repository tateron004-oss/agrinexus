...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-464", "agrinexus-pwa-v409"])
  && hasAll(app, ["nexus-behavior-464", "agrinexus-pwa-v409"])
  && hasAll(sw, ["nexus-behavior-464", "agrinexus-pwa-v409"]));
