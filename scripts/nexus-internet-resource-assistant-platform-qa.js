...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-407", "agrinexus-pwa-v358"])
  && hasAll(app, ["nexus-behavior-407", "agrinexus-pwa-v358"])
  && hasAll(sw, ["nexus-behavior-407", "agrinexus-pwa-v358"]));
