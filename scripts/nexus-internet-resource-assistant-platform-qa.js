...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-431", "agrinexus-pwa-v376"])
  && hasAll(app, ["nexus-behavior-431", "agrinexus-pwa-v376"])
  && hasAll(sw, ["nexus-behavior-431", "agrinexus-pwa-v376"]));
