...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-443", "agrinexus-pwa-v388"])
  && hasAll(app, ["nexus-behavior-443", "agrinexus-pwa-v388"])
  && hasAll(sw, ["nexus-behavior-443", "agrinexus-pwa-v388"]));
