...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-453", "agrinexus-pwa-v398"])
  && hasAll(app, ["nexus-behavior-453", "agrinexus-pwa-v398"])
  && hasAll(sw, ["nexus-behavior-453", "agrinexus-pwa-v398"]));
