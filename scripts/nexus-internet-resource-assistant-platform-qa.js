...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-434", "agrinexus-pwa-v379"])
  && hasAll(app, ["nexus-behavior-434", "agrinexus-pwa-v379"])
  && hasAll(sw, ["nexus-behavior-434", "agrinexus-pwa-v379"]));
