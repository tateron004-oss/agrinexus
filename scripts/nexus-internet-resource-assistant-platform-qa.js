...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-506", "agrinexus-pwa-v451"])
  && hasAll(app, ["nexus-behavior-506", "agrinexus-pwa-v451"])
  && hasAll(sw, ["nexus-behavior-506", "agrinexus-pwa-v451"]));
