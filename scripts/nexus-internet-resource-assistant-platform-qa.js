...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-460", "agrinexus-pwa-v405"])
  && hasAll(app, ["nexus-behavior-460", "agrinexus-pwa-v405"])
  && hasAll(sw, ["nexus-behavior-460", "agrinexus-pwa-v405"]));
