...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-461", "agrinexus-pwa-v406"])
  && hasAll(app, ["nexus-behavior-461", "agrinexus-pwa-v406"])
  && hasAll(sw, ["nexus-behavior-461", "agrinexus-pwa-v406"]));
