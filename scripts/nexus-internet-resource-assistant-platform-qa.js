...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-414", "agrinexus-pwa-v365"])
  && hasAll(app, ["nexus-behavior-414", "agrinexus-pwa-v365"])
  && hasAll(sw, ["nexus-behavior-414", "agrinexus-pwa-v365"]));
