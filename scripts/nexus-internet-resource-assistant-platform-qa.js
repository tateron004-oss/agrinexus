...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-406", "agrinexus-pwa-v357"])
  && hasAll(app, ["nexus-behavior-406", "agrinexus-pwa-v357"])
  && hasAll(sw, ["nexus-behavior-406", "agrinexus-pwa-v357"]));
