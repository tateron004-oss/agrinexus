...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-447", "agrinexus-pwa-v392"])
  && hasAll(app, ["nexus-behavior-447", "agrinexus-pwa-v392"])
  && hasAll(sw, ["nexus-behavior-447", "agrinexus-pwa-v392"]));
