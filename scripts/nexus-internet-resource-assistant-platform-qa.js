...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-489", "agrinexus-pwa-v434"])
  && hasAll(app, ["nexus-behavior-489", "agrinexus-pwa-v434"])
  && hasAll(sw, ["nexus-behavior-489", "agrinexus-pwa-v434"]));
