...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-352", "agrinexus-pwa-v331"])
  && hasAll(app, ["nexus-behavior-352", "agrinexus-pwa-v331"])
  && hasAll(sw, ["nexus-behavior-352", "agrinexus-pwa-v331"]));
