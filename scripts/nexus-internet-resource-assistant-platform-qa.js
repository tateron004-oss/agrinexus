...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-490", "agrinexus-pwa-v435"])
  && hasAll(app, ["nexus-behavior-490", "agrinexus-pwa-v435"])
  && hasAll(sw, ["nexus-behavior-490", "agrinexus-pwa-v435"]));
