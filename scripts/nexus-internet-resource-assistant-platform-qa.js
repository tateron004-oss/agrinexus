...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-482", "agrinexus-pwa-v427"])
  && hasAll(app, ["nexus-behavior-482", "agrinexus-pwa-v427"])
  && hasAll(sw, ["nexus-behavior-482", "agrinexus-pwa-v427"]));
