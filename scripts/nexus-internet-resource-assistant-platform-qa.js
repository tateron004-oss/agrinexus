...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-500", "agrinexus-pwa-v445"])
  && hasAll(app, ["nexus-behavior-500", "agrinexus-pwa-v445"])
  && hasAll(sw, ["nexus-behavior-500", "agrinexus-pwa-v445"]));
