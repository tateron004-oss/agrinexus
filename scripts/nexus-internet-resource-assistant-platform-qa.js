...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-440", "agrinexus-pwa-v385"])
  && hasAll(app, ["nexus-behavior-440", "agrinexus-pwa-v385"])
  && hasAll(sw, ["nexus-behavior-440", "agrinexus-pwa-v385"]));
