...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-491", "agrinexus-pwa-v436"])
  && hasAll(app, ["nexus-behavior-491", "agrinexus-pwa-v436"])
  && hasAll(sw, ["nexus-behavior-491", "agrinexus-pwa-v436"]));
