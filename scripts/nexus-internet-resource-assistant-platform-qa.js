...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-469", "agrinexus-pwa-v414"])
  && hasAll(app, ["nexus-behavior-469", "agrinexus-pwa-v414"])
  && hasAll(sw, ["nexus-behavior-469", "agrinexus-pwa-v414"]));
