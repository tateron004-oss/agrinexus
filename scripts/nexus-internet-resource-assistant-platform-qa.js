...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-493", "agrinexus-pwa-v438"])
  && hasAll(app, ["nexus-behavior-493", "agrinexus-pwa-v438"])
  && hasAll(sw, ["nexus-behavior-493", "agrinexus-pwa-v438"]));
