...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-509", "agrinexus-pwa-v454"])
  && hasAll(app, ["nexus-behavior-509", "agrinexus-pwa-v454"])
  && hasAll(sw, ["nexus-behavior-509", "agrinexus-pwa-v454"]));
