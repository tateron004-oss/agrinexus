...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-510", "agrinexus-pwa-v455"])
  && hasAll(app, ["nexus-behavior-510", "agrinexus-pwa-v455"])
  && hasAll(sw, ["nexus-behavior-510", "agrinexus-pwa-v455"]));
