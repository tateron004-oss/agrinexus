...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-475", "agrinexus-pwa-v420"])
  && hasAll(app, ["nexus-behavior-475", "agrinexus-pwa-v420"])
  && hasAll(sw, ["nexus-behavior-475", "agrinexus-pwa-v420"]));
