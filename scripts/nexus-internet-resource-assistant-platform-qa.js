...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-439", "agrinexus-pwa-v384"])
  && hasAll(app, ["nexus-behavior-439", "agrinexus-pwa-v384"])
  && hasAll(sw, ["nexus-behavior-439", "agrinexus-pwa-v384"]));
