...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-408", "agrinexus-pwa-v359"])
  && hasAll(app, ["nexus-behavior-408", "agrinexus-pwa-v359"])
  && hasAll(sw, ["nexus-behavior-408", "agrinexus-pwa-v359"]));
