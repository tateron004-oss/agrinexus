...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-488", "agrinexus-pwa-v433"])
  && hasAll(app, ["nexus-behavior-488", "agrinexus-pwa-v433"])
  && hasAll(sw, ["nexus-behavior-488", "agrinexus-pwa-v433"]));
