...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-492", "agrinexus-pwa-v437"])
  && hasAll(app, ["nexus-behavior-492", "agrinexus-pwa-v437"])
  && hasAll(sw, ["nexus-behavior-492", "agrinexus-pwa-v437"]));
