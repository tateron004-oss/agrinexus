...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-503", "agrinexus-pwa-v448"])
  && hasAll(app, ["nexus-behavior-503", "agrinexus-pwa-v448"])
  && hasAll(sw, ["nexus-behavior-503", "agrinexus-pwa-v448"]));
