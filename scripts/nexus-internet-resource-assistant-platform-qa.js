...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-380", "agrinexus-pwa-v354"])
  && hasAll(app, ["nexus-behavior-380", "agrinexus-pwa-v354"])
  && hasAll(sw, ["nexus-behavior-380", "agrinexus-pwa-v354"]));
