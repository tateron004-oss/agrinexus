...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-360", "agrinexus-pwa-v339"])
  && hasAll(app, ["nexus-behavior-360", "agrinexus-pwa-v339"])
  && hasAll(sw, ["nexus-behavior-360", "agrinexus-pwa-v339"]));
