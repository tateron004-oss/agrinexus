...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-441", "agrinexus-pwa-v386"])
  && hasAll(app, ["nexus-behavior-441", "agrinexus-pwa-v386"])
  && hasAll(sw, ["nexus-behavior-441", "agrinexus-pwa-v386"]));
