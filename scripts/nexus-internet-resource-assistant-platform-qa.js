...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-474", "agrinexus-pwa-v419"])
  && hasAll(app, ["nexus-behavior-474", "agrinexus-pwa-v419"])
  && hasAll(sw, ["nexus-behavior-474", "agrinexus-pwa-v419"]));
