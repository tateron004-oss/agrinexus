...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-376", "agrinexus-pwa-v350"])
  && hasAll(app, ["nexus-behavior-376", "agrinexus-pwa-v350"])
  && hasAll(sw, ["nexus-behavior-376", "agrinexus-pwa-v350"]));
