...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-465", "agrinexus-pwa-v410"])
  && hasAll(app, ["nexus-behavior-465", "agrinexus-pwa-v410"])
  && hasAll(sw, ["nexus-behavior-465", "agrinexus-pwa-v410"]));
