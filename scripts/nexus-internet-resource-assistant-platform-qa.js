...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-435", "agrinexus-pwa-v380"])
  && hasAll(app, ["nexus-behavior-435", "agrinexus-pwa-v380"])
  && hasAll(sw, ["nexus-behavior-435", "agrinexus-pwa-v380"]));
