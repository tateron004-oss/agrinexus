...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-413", "agrinexus-pwa-v364"])
  && hasAll(app, ["nexus-behavior-413", "agrinexus-pwa-v364"])
  && hasAll(sw, ["nexus-behavior-413", "agrinexus-pwa-v364"]));
