...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-353", "agrinexus-pwa-v332"])
  && hasAll(app, ["nexus-behavior-353", "agrinexus-pwa-v332"])
  && hasAll(sw, ["nexus-behavior-353", "agrinexus-pwa-v332"]));
