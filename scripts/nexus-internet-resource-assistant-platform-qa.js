...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-466", "agrinexus-pwa-v411"])
  && hasAll(app, ["nexus-behavior-466", "agrinexus-pwa-v411"])
  && hasAll(sw, ["nexus-behavior-466", "agrinexus-pwa-v411"]));
