...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-472", "agrinexus-pwa-v417"])
  && hasAll(app, ["nexus-behavior-472", "agrinexus-pwa-v417"])
  && hasAll(sw, ["nexus-behavior-472", "agrinexus-pwa-v417"]));
