...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-436", "agrinexus-pwa-v381"])
  && hasAll(app, ["nexus-behavior-436", "agrinexus-pwa-v381"])
  && hasAll(sw, ["nexus-behavior-436", "agrinexus-pwa-v381"]));
