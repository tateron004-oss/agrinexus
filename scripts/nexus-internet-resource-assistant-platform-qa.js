...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-452", "agrinexus-pwa-v397"])
  && hasAll(app, ["nexus-behavior-452", "agrinexus-pwa-v397"])
  && hasAll(sw, ["nexus-behavior-452", "agrinexus-pwa-v397"]));
