...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-351", "agrinexus-pwa-v330"])
  && hasAll(app, ["nexus-behavior-351", "agrinexus-pwa-v330"])
  && hasAll(sw, ["nexus-behavior-351", "agrinexus-pwa-v330"]));
