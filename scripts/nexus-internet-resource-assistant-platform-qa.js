...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-442", "agrinexus-pwa-v387"])
  && hasAll(app, ["nexus-behavior-442", "agrinexus-pwa-v387"])
  && hasAll(sw, ["nexus-behavior-442", "agrinexus-pwa-v387"]));
