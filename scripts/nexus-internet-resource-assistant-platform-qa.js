...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-438", "agrinexus-pwa-v383"])
  && hasAll(app, ["nexus-behavior-438", "agrinexus-pwa-v383"])
  && hasAll(sw, ["nexus-behavior-438", "agrinexus-pwa-v383"]));
