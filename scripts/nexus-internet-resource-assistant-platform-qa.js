...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-478", "agrinexus-pwa-v423"])
  && hasAll(app, ["nexus-behavior-478", "agrinexus-pwa-v423"])
  && hasAll(sw, ["nexus-behavior-478", "agrinexus-pwa-v423"]));
