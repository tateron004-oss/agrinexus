...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-507", "agrinexus-pwa-v452"])
  && hasAll(app, ["nexus-behavior-507", "agrinexus-pwa-v452"])
  && hasAll(sw, ["nexus-behavior-507", "agrinexus-pwa-v452"]));
