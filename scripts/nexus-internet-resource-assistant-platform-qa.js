...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-444", "agrinexus-pwa-v389"])
  && hasAll(app, ["nexus-behavior-444", "agrinexus-pwa-v389"])
  && hasAll(sw, ["nexus-behavior-444", "agrinexus-pwa-v389"]));
