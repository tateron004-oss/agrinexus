...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-432", "agrinexus-pwa-v377"])
  && hasAll(app, ["nexus-behavior-432", "agrinexus-pwa-v377"])
  && hasAll(sw, ["nexus-behavior-432", "agrinexus-pwa-v377"]));
