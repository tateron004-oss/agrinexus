...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-479", "agrinexus-pwa-v424"])
  && hasAll(app, ["nexus-behavior-479", "agrinexus-pwa-v424"])
  && hasAll(sw, ["nexus-behavior-479", "agrinexus-pwa-v424"]));
