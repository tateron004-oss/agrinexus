...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-480", "agrinexus-pwa-v425"])
  && hasAll(app, ["nexus-behavior-480", "agrinexus-pwa-v425"])
  && hasAll(sw, ["nexus-behavior-480", "agrinexus-pwa-v425"]));
