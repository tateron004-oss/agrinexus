...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-468", "agrinexus-pwa-v413"])
  && hasAll(app, ["nexus-behavior-468", "agrinexus-pwa-v413"])
  && hasAll(sw, ["nexus-behavior-468", "agrinexus-pwa-v413"]));
