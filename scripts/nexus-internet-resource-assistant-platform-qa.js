...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-392", "agrinexus-pwa-v356"])
  && hasAll(app, ["nexus-behavior-392", "agrinexus-pwa-v356"])
  && hasAll(sw, ["nexus-behavior-392", "agrinexus-pwa-v356"]));
