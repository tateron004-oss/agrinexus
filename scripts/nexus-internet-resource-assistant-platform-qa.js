...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-354", "agrinexus-pwa-v333"])
  && hasAll(app, ["nexus-behavior-354", "agrinexus-pwa-v333"])
  && hasAll(sw, ["nexus-behavior-354", "agrinexus-pwa-v333"]));
