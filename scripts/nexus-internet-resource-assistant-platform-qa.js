...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-379", "agrinexus-pwa-v353"])
  && hasAll(app, ["nexus-behavior-379", "agrinexus-pwa-v353"])
  && hasAll(sw, ["nexus-behavior-379", "agrinexus-pwa-v353"]));
