...
check("service worker/cache bumped for frontend change", hasAll(server, ["nexus-behavior-477", "agrinexus-pwa-v422"])
  && hasAll(app, ["nexus-behavior-477", "agrinexus-pwa-v422"])
  && hasAll(sw, ["nexus-behavior-477", "agrinexus-pwa-v422"]));
