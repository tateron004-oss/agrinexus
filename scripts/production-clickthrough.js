...
assert(html.includes("styles.css?v=nexus-behavior-115"), "Index must force browsers to load the latest Nexus behavior shell");
assert(html.includes("app.js?v=nexus-behavior-115"), "Index must force browsers to load the latest Nexus behavior code");
assert(sw.includes("agrinexus-pwa-v95"), "Service worker cache must refresh the installed app after native voice bridge updates");
