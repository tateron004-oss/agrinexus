...
assert(html.includes("styles.css?v=user-mobile-28"), "Index must force browsers to load the latest user mobile styling");
assert(html.includes("app.js?v=user-mobile-41"), "Index must force browsers to load the latest user mobile code");
assert(sw.includes("agrinexus-pwa-v20"), "Service worker cache must refresh the installed app after user mobile updates");
