...
assert(html.includes("styles.css?v=grandma-modal-43"), "Index must force browsers to load the latest Grandma Mode modal shell");
assert(html.includes("app.js?v=grandma-modal-56"), "Index must force browsers to load the latest Grandma Mode modal code");
assert(sw.includes("agrinexus-pwa-v35"), "Service worker cache must refresh the installed app after Grandma Mode modal updates");
