...
assert(html.includes("styles.css?v=all-language-voice-50"), "Index must force browsers to load the latest all-language voice shell");
assert(html.includes("app.js?v=all-language-voice-63"), "Index must force browsers to load the latest all-language voice code");
assert(sw.includes("agrinexus-pwa-v42"), "Service worker cache must refresh the installed app after all-language voice updates");
