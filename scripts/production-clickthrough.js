...
assert(html.includes("styles.css?v=user-buttons-33"), "Index must force browsers to load the latest button-based user styling");
assert(html.includes("app.js?v=user-buttons-46"), "Index must force browsers to load the latest button-based user code");
assert(sw.includes("agrinexus-pwa-v25"), "Service worker cache must refresh the installed app after button-based user updates");
