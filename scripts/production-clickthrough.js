...
assert(html.includes("styles.css?v=nexus-behavior-156"), "Index must force browsers to load the latest Nexus behavior shell");
assert(html.includes("app.js?v=nexus-behavior-156"), "Index must force browsers to load the latest Nexus behavior code");
assert(html.includes("topSettingsClose"), "Settings menu needs a visible close control");
assert(sw.includes("agrinexus-pwa-v136"), "Service worker cache must refresh the installed app after native voice bridge updates");
...
assert(sw.includes("BUILD_VERSION = \"nexus-behavior-156\""), "Service worker must know the current app build version");
