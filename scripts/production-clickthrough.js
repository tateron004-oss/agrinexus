...
assert(html.includes("styles.css?v=grandma-contained-42"), "Index must force browsers to load the latest contained Grandma Mode shell");
assert(html.includes("app.js?v=grandma-contained-55"), "Index must force browsers to load the latest contained Grandma Mode code");
assert(sw.includes("agrinexus-pwa-v34"), "Service worker cache must refresh the installed app after contained Grandma Mode updates");
