...
assert(html.includes("styles.css?v=launch-wizard-31"), "Index must force browsers to load the latest launch wizard styling");
assert(html.includes("app.js?v=launch-wizard-44"), "Index must force browsers to load the latest launch wizard code");
assert(sw.includes("agrinexus-pwa-v23"), "Service worker cache must refresh the installed app after launch wizard updates");
