...
assert(html.includes("app.js?v=user-mode-40"), "Index must force browsers to load the latest user mode code");
assert(sw.includes("agrinexus-pwa-v19"), "Service worker cache must refresh the installed app after user mode updates");
