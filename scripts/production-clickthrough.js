...
assert(html.includes("app.js?v=twoway-comms-38"), "Index must force browsers to load the latest two-way communications code");
assert(sw.includes("agrinexus-pwa-v17"), "Service worker cache must refresh the installed app after two-way communications updates");
