...
assert(html.includes("styles.css?v=simple-user-32"), "Index must force browsers to load the latest simple user styling");
assert(html.includes("app.js?v=simple-user-45"), "Index must force browsers to load the latest simple user code");
assert(sw.includes("agrinexus-pwa-v24"), "Service worker cache must refresh the installed app after simple user updates");
