...
assert(html.includes("styles.css?v=grandma-simple-37"), "Index must force browsers to load the latest grandma-simple user shell");
assert(html.includes("app.js?v=grandma-simple-50"), "Index must force browsers to load the latest grandma-simple user code");
assert(sw.includes("agrinexus-pwa-v29"), "Service worker cache must refresh the installed app after grandma-simple updates");
