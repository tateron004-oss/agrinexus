...
assert(html.includes("styles.css?v=user-phone-shell-35"), "Index must force browsers to load the latest phone-style user shell");
assert(html.includes("app.js?v=user-phone-shell-48"), "Index must force browsers to load the latest phone-style user code");
assert(sw.includes("agrinexus-pwa-v27"), "Service worker cache must refresh the installed app after phone-style user updates");
...
assert(styles.includes("body.user-mode .user-mobile-dock"), "Phone-style user shell needs bottom app navigation");
