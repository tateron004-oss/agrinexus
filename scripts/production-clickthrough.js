...
assert(html.includes("styles.css?v=provider-mobile-30"), "Index must force browsers to load the latest provider/mobile styling");
assert(html.includes("app.js?v=provider-mobile-43"), "Index must force browsers to load the latest provider/mobile code");
assert(sw.includes("agrinexus-pwa-v22"), "Service worker cache must refresh the installed app after provider/mobile updates");
