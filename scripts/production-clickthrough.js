...
assert(html.includes("styles.css?v=universal-voice-help-49"), "Index must force browsers to load the latest universal voice help shell");
assert(html.includes("app.js?v=universal-voice-help-62"), "Index must force browsers to load the latest universal voice help code");
assert(sw.includes("agrinexus-pwa-v41"), "Service worker cache must refresh the installed app after universal voice help updates");
