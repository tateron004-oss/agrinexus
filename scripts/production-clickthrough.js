...
assert(html.includes("app.js?v=ai-orchestration-39"), "Index must force browsers to load the latest AI orchestration code");
assert(sw.includes("agrinexus-pwa-v18"), "Service worker cache must refresh the installed app after AI orchestration updates");
