...
assert(html.includes("styles.css?v=button-only-38"), "Index must force browsers to load the latest button-only user shell");
assert(html.includes("app.js?v=button-only-51"), "Index must force browsers to load the latest button-only user code");
assert(sw.includes("agrinexus-pwa-v30"), "Service worker cache must refresh the installed app after button-only updates");
