...
assert(html.includes("styles.css?v=simple-buttons-36"), "Index must force browsers to load the latest simple button user shell");
assert(html.includes("app.js?v=simple-buttons-49"), "Index must force browsers to load the latest simple button user code");
assert(sw.includes("agrinexus-pwa-v28"), "Service worker cache must refresh the installed app after simple button updates");
...
assert(app.includes("What do you need?"), "Standard User view needs short user-ready copy");
