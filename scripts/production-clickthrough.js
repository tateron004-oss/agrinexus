...
assert(html.includes("styles.css?v=grandma-safe-41"), "Index must force browsers to load the latest Grandma-safe user shell");
assert(html.includes("app.js?v=grandma-safe-54"), "Index must force browsers to load the latest Grandma-safe user code");
assert(sw.includes("agrinexus-pwa-v33"), "Service worker cache must refresh the installed app after Grandma-safe updates");
