...
assert(html.includes("styles.css?v=grandma-color-45"), "Index must force browsers to load the latest colorful Grandma Mode shell");
assert(html.includes("app.js?v=grandma-color-58"), "Index must force browsers to load the latest colorful Grandma Mode code");
assert(sw.includes("agrinexus-pwa-v37"), "Service worker cache must refresh the installed app after colorful Grandma Mode updates");
