...
assert(html.includes("app.js?v=communications-37"), "Index must force browsers to load the latest communications code");
assert(sw.includes("agrinexus-pwa-v16"), "Service worker cache must refresh the installed app after communications updates");
