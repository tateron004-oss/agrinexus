...
assert(html.includes("styles.css?v=color-actions-39"), "Index must force browsers to load the latest color-coded action user shell");
assert(html.includes("app.js?v=color-actions-52"), "Index must force browsers to load the latest color-coded action user code");
assert(sw.includes("agrinexus-pwa-v31"), "Service worker cache must refresh the installed app after color-coded action updates");
