...
assert(html.includes("styles.css?v=grandma-universal-44"), "Index must force browsers to load the latest universal Grandma Mode shell");
assert(html.includes("app.js?v=grandma-universal-57"), "Index must force browsers to load the latest universal Grandma Mode code");
assert(sw.includes("agrinexus-pwa-v36"), "Service worker cache must refresh the installed app after universal Grandma Mode updates");
