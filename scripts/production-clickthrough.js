...
assert(html.includes("styles.css?v=user-studio-29"), "Index must force browsers to load the latest user studio styling");
assert(html.includes("app.js?v=user-studio-42"), "Index must force browsers to load the latest user studio code");
assert(sw.includes("agrinexus-pwa-v21"), "Service worker cache must refresh the installed app after user studio updates");
