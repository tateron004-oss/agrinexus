...
assert(html.includes("styles.css?v=visible-language-panel-51"), "Index must force browsers to load the latest visible language panel shell");
assert(html.includes("app.js?v=visible-language-panel-64"), "Index must force browsers to load the latest visible language panel code");
assert(sw.includes("agrinexus-pwa-v43"), "Service worker cache must refresh the installed app after visible language panel updates");
