...
assert(html.includes("styles.css?v=grandma-mode-40"), "Index must force browsers to load the latest Grandma Mode user shell");
assert(html.includes("app.js?v=grandma-mode-53"), "Index must force browsers to load the latest Grandma Mode user code");
assert(sw.includes("agrinexus-pwa-v32"), "Service worker cache must refresh the installed app after Grandma Mode updates");
