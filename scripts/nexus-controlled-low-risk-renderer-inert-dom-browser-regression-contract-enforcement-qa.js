...
assert(!index.includes("data-nexus-renderer-mode"), "public/index.html must not include renderer output");
assert(!index.includes("data-execution-allowed"), "public/index.html must not include renderer output");
assert(!index.includes("controlled-low-risk-renderer"), "public/index.html must not include visible renderer roots");
