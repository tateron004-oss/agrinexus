...
const workflowActions = [
  ...
  ["health", "nearest-clinic"],
  ["health", "mobile-clinic"],
  ["health", "pharmacy"],
  ["health", "handoff"],
  ["health", "supply-request"],
  ["health", "supply-match"],
  ["health", "supply-dispatch"],
  ["health", "supply-delivery"],
  ["health", "clinic-service-menu"],
  ["health", "clinic-payment-request"],
  ["health", "clinic-receipt"],
  ["health", "clinic-payout"],
  ["trade", "order"],
  ["trade", "advance"],
  ["trade", "logistics-quote"],
  ["trade", "shipping-booking"],
  ["trade", "buyer-pickup"],
