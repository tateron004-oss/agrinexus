...
includes(index, "/manifest.webmanifest?v=nexus-behavior-443", "manifest cache marker");
includes(index, "/styles.css?v=nexus-behavior-443", "stylesheet cache marker");
includes(index, "/app.js?v=nexus-behavior-443", "app cache marker");
includes(app, 'AGRINEXUS_BUILD_VERSION = "nexus-behavior-443"', "app build marker");
includes(app, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v388"', "app PWA cache marker");
includes(server, 'AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-443"', "server build marker");
includes(server, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v388"', "server PWA cache marker");
includes(sw, 'CACHE_NAME = "agrinexus-pwa-v388"', "service worker cache marker");
includes(sw, 'BUILD_VERSION = "nexus-behavior-443"', "service worker build marker");
