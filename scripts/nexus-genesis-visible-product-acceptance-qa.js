...
includes(index, "/manifest.webmanifest?v=nexus-behavior-503", "manifest cache marker");
includes(index, "/styles.css?v=nexus-behavior-503", "stylesheet cache marker");
includes(index, "/app.js?v=nexus-behavior-503", "app cache marker");
includes(app, 'AGRINEXUS_BUILD_VERSION = "nexus-behavior-503"', "app build marker");
includes(app, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v448"', "app PWA cache marker");
includes(server, 'AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-503"', "server build marker");
includes(server, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v448"', "server PWA cache marker");
includes(sw, 'CACHE_NAME = "agrinexus-pwa-v448"', "service worker cache marker");
includes(sw, 'BUILD_VERSION = "nexus-behavior-503"', "service worker build marker");
