...
includes(index, "/manifest.webmanifest?v=nexus-behavior-499", "manifest cache marker");
includes(index, "/styles.css?v=nexus-behavior-499", "stylesheet cache marker");
includes(index, "/app.js?v=nexus-behavior-499", "app cache marker");
includes(app, 'AGRINEXUS_BUILD_VERSION = "nexus-behavior-499"', "app build marker");
includes(app, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v444"', "app PWA cache marker");
includes(server, 'AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-499"', "server build marker");
includes(server, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v444"', "server PWA cache marker");
includes(sw, 'CACHE_NAME = "agrinexus-pwa-v444"', "service worker cache marker");
includes(sw, 'BUILD_VERSION = "nexus-behavior-499"', "service worker build marker");
