...
includes(index, "/manifest.webmanifest?v=nexus-behavior-509", "manifest cache marker");
includes(index, "/styles.css?v=nexus-behavior-509", "stylesheet cache marker");
includes(index, "/app.js?v=nexus-behavior-509", "app cache marker");
includes(app, 'AGRINEXUS_BUILD_VERSION = "nexus-behavior-509"', "app build marker");
includes(app, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v454"', "app PWA cache marker");
includes(server, 'AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-509"', "server build marker");
includes(server, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v454"', "server PWA cache marker");
includes(sw, 'CACHE_NAME = "agrinexus-pwa-v454"', "service worker cache marker");
includes(sw, 'BUILD_VERSION = "nexus-behavior-509"', "service worker build marker");
