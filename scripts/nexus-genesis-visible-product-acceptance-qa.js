...
includes(index, "/manifest.webmanifest?v=nexus-behavior-475", "manifest cache marker");
includes(index, "/styles.css?v=nexus-behavior-475", "stylesheet cache marker");
includes(index, "/app.js?v=nexus-behavior-475", "app cache marker");
includes(app, 'AGRINEXUS_BUILD_VERSION = "nexus-behavior-475"', "app build marker");
includes(app, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v420"', "app PWA cache marker");
includes(server, 'AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-475"', "server build marker");
includes(server, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v420"', "server PWA cache marker");
includes(sw, 'CACHE_NAME = "agrinexus-pwa-v420"', "service worker cache marker");
includes(sw, 'BUILD_VERSION = "nexus-behavior-475"', "service worker build marker");
