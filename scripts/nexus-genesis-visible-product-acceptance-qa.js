...
includes(index, "/manifest.webmanifest?v=nexus-behavior-466", "manifest cache marker");
includes(index, "/styles.css?v=nexus-behavior-466", "stylesheet cache marker");
includes(index, "/app.js?v=nexus-behavior-466", "app cache marker");
includes(app, 'AGRINEXUS_BUILD_VERSION = "nexus-behavior-466"', "app build marker");
includes(app, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v411"', "app PWA cache marker");
includes(server, 'AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-466"', "server build marker");
includes(server, 'AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v411"', "server PWA cache marker");
includes(sw, 'CACHE_NAME = "agrinexus-pwa-v411"', "service worker cache marker");
includes(sw, 'BUILD_VERSION = "nexus-behavior-466"', "service worker build marker");
