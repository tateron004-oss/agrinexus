...
assert(app.includes("nexus-behavior-469"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-469"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v414"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v414"), "server PWA cache identifier must be bumped");
