...
assert(app.includes("nexus-behavior-463"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-463"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v408"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v408"), "server PWA cache identifier must be bumped");
