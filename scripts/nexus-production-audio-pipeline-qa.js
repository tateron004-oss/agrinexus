...
assert(app.includes("nexus-behavior-511"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-511"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v456"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v456"), "server PWA cache identifier must be bumped");
