...
assert(app.includes("nexus-behavior-447"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-447"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v392"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v392"), "server PWA cache identifier must be bumped");
