...
assert(app.includes("nexus-behavior-458"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-458"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v403"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v403"), "server PWA cache identifier must be bumped");
