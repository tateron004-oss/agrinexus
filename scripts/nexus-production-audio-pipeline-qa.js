...
assert(app.includes("nexus-behavior-455"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-455"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v400"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v400"), "server PWA cache identifier must be bumped");
