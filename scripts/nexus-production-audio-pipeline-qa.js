...
assert(app.includes("nexus-behavior-456"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-456"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v401"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v401"), "server PWA cache identifier must be bumped");
