...
assert(app.includes("nexus-behavior-510"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-510"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v455"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v455"), "server PWA cache identifier must be bumped");
