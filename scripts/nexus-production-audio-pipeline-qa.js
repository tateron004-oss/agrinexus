...
assert(app.includes("nexus-behavior-459"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-459"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v404"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v404"), "server PWA cache identifier must be bumped");
