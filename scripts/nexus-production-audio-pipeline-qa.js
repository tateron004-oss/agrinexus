...
assert(app.includes("nexus-behavior-490"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-490"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v435"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v435"), "server PWA cache identifier must be bumped");
