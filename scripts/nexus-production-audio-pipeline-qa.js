...
assert(app.includes("nexus-behavior-488"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-488"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v433"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v433"), "server PWA cache identifier must be bumped");
