...
assert(app.includes("nexus-behavior-507"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-507"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v452"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v452"), "server PWA cache identifier must be bumped");
