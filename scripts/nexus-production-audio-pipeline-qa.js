...
assert(app.includes("nexus-behavior-453"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-453"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v398"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v398"), "server PWA cache identifier must be bumped");
