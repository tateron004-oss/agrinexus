...
assert(app.includes("nexus-behavior-475"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-475"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v420"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v420"), "server PWA cache identifier must be bumped");
