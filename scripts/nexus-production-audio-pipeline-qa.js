...
assert(app.includes("nexus-behavior-491"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-491"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v436"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v436"), "server PWA cache identifier must be bumped");
