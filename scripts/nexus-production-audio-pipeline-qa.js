...
assert(app.includes("nexus-behavior-452"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-452"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v397"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v397"), "server PWA cache identifier must be bumped");
