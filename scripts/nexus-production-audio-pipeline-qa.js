...
assert(app.includes("nexus-behavior-492"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-492"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v437"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v437"), "server PWA cache identifier must be bumped");
