...
assert(app.includes("nexus-behavior-461"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-461"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v406"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v406"), "server PWA cache identifier must be bumped");
