...
assert(app.includes("nexus-behavior-445"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-445"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v390"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v390"), "server PWA cache identifier must be bumped");
