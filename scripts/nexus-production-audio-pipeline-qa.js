...
assert(app.includes("nexus-behavior-489"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-489"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v434"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v434"), "server PWA cache identifier must be bumped");
