...
assert(app.includes("nexus-behavior-474"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-474"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v419"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v419"), "server PWA cache identifier must be bumped");
