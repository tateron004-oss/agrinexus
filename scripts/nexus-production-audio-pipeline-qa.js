...
assert(app.includes("nexus-behavior-478"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-478"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v423"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v423"), "server PWA cache identifier must be bumped");
