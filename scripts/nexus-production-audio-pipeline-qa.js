...
assert(app.includes("nexus-behavior-503"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-503"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v448"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v448"), "server PWA cache identifier must be bumped");
