...
assert(app.includes("nexus-behavior-451"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-451"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v396"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v396"), "server PWA cache identifier must be bumped");
