...
assert(app.includes("nexus-behavior-509"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-509"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v454"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v454"), "server PWA cache identifier must be bumped");
