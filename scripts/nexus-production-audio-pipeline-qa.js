...
assert(app.includes("nexus-behavior-476"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-476"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v421"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v421"), "server PWA cache identifier must be bumped");
