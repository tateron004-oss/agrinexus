...
assert(app.includes('AGRINEXUS_BUILD_VERSION = "__NEXUS_RELEASE_SHA__"'), "app build must use immutable release identity");
assert(server.includes("AGRINEXUS_WEB_BUILD_VERSION = NEXUS_EFFECTIVE_RELEASE_SHA"), "server build must use immutable release identity");
assert(app.includes('AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-__NEXUS_RELEASE_SHA__"'), "app cache must derive from immutable release identity");
assert(server.includes("AGRINEXUS_PWA_CACHE_VERSION = `agrinexus-pwa-${NEXUS_EFFECTIVE_RELEASE_SHA}`"), "server cache must derive from immutable release identity");
