...
assert(app.includes("nexus-behavior-487"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-487"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v432"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v432"), "server PWA cache identifier must be bumped");
