...
assert(app.includes("nexus-behavior-480"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-480"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v425"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v425"), "server PWA cache identifier must be bumped");
