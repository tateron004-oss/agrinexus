...
assert(app.includes("nexus-behavior-457"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-457"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v402"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v402"), "server PWA cache identifier must be bumped");
