...
assert(app.includes("nexus-behavior-472"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-472"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v417"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v417"), "server PWA cache identifier must be bumped");
