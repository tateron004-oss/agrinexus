...
assert(app.includes("nexus-behavior-499"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-499"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v444"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v444"), "server PWA cache identifier must be bumped");
