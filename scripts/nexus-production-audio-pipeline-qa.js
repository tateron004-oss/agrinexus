...
assert(app.includes("nexus-behavior-504"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-504"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v449"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v449"), "server PWA cache identifier must be bumped");
