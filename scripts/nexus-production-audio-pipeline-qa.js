...
assert(app.includes("nexus-behavior-450"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-450"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v395"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v395"), "server PWA cache identifier must be bumped");
