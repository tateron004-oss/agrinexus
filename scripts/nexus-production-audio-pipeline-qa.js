...
assert(app.includes("nexus-behavior-467"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-467"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v412"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v412"), "server PWA cache identifier must be bumped");
