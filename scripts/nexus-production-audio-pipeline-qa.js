...
assert(app.includes("nexus-behavior-462"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-462"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v407"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v407"), "server PWA cache identifier must be bumped");
