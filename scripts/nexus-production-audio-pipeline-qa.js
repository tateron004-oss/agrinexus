...
assert(app.includes("nexus-behavior-483"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-483"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v428"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v428"), "server PWA cache identifier must be bumped");
