...
assert(app.includes("nexus-behavior-502"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-502"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v447"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v447"), "server PWA cache identifier must be bumped");
