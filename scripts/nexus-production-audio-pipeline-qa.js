...
assert(app.includes("nexus-behavior-494"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-494"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v439"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v439"), "server PWA cache identifier must be bumped");
