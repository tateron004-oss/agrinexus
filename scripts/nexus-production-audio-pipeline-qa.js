...
assert(app.includes("nexus-behavior-438"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-438"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v383"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v383"), "server PWA cache identifier must be bumped");
