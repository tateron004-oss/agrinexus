...
assert(app.includes("nexus-behavior-436"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-436"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v381"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v381"), "server PWA cache identifier must be bumped");
