...
assert(app.includes("nexus-behavior-505"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-505"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v450"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v450"), "server PWA cache identifier must be bumped");
