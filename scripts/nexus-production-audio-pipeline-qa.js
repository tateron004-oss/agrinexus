...
assert(app.includes("nexus-behavior-468"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-468"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v413"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v413"), "server PWA cache identifier must be bumped");
