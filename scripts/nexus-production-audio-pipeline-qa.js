...
assert(app.includes("nexus-behavior-501"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-501"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v446"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v446"), "server PWA cache identifier must be bumped");
