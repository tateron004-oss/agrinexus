...
assert(app.includes("nexus-behavior-448"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-448"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v393"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v393"), "server PWA cache identifier must be bumped");
