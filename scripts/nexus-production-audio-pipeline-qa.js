...
assert(app.includes("nexus-behavior-493"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-493"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v438"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v438"), "server PWA cache identifier must be bumped");
