...
assert(app.includes("nexus-behavior-473"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-473"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v418"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v418"), "server PWA cache identifier must be bumped");
