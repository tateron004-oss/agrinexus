...
assert(app.includes("nexus-behavior-512"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-512"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v457"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v457"), "server PWA cache identifier must be bumped");
