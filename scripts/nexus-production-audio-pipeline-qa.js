...
assert(app.includes("nexus-behavior-435"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-435"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v380"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v380"), "server PWA cache identifier must be bumped");
