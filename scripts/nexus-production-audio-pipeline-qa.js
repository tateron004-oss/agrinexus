...
assert(app.includes("nexus-behavior-500"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-500"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v445"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v445"), "server PWA cache identifier must be bumped");
