...
assert(app.includes("nexus-behavior-454"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-454"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v399"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v399"), "server PWA cache identifier must be bumped");
