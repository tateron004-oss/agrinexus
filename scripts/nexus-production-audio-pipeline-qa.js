...
assert(app.includes("nexus-behavior-482"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-482"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v427"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v427"), "server PWA cache identifier must be bumped");
