...
assert(app.includes("nexus-behavior-479"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-479"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v424"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v424"), "server PWA cache identifier must be bumped");
