...
assert(app.includes("nexus-behavior-464"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-464"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v409"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v409"), "server PWA cache identifier must be bumped");
