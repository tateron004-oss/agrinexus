...
assert(app.includes("nexus-behavior-441"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-441"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v386"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v386"), "server PWA cache identifier must be bumped");
