...
assert(app.includes("nexus-behavior-466"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-466"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v411"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v411"), "server PWA cache identifier must be bumped");
