...
assert(app.includes("nexus-behavior-449"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-449"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v394"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v394"), "server PWA cache identifier must be bumped");
