...
assert(app.includes("nexus-behavior-477"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-477"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v422"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v422"), "server PWA cache identifier must be bumped");
