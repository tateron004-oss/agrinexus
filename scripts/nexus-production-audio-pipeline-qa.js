...
assert(app.includes("nexus-behavior-437"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-437"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v382"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v382"), "server PWA cache identifier must be bumped");
