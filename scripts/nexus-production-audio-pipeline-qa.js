...
assert(app.includes("nexus-behavior-442"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-442"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v387"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v387"), "server PWA cache identifier must be bumped");
