...
assert(app.includes("nexus-behavior-460"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-460"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v405"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v405"), "server PWA cache identifier must be bumped");
