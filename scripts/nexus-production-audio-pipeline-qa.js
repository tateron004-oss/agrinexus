...
assert(app.includes("nexus-behavior-508"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-508"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v453"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v453"), "server PWA cache identifier must be bumped");
