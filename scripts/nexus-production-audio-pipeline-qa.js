...
assert(app.includes("nexus-behavior-465"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-465"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v410"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v410"), "server PWA cache identifier must be bumped");
