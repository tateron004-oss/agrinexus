...
assert(app.includes("nexus-behavior-506"), "app build identifier must be bumped");
assert(server.includes("nexus-behavior-506"), "server build identifier must be bumped");
assert(app.includes("agrinexus-pwa-v451"), "app PWA cache identifier must be bumped");
assert(server.includes("agrinexus-pwa-v451"), "server PWA cache identifier must be bumped");
