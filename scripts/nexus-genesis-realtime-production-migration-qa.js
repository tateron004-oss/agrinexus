...
const requirements = [
  ...
  ["Client Realtime controller", app.includes("async function startRealtimeVoiceSession") && app.includes("new RTCPeerConnection") && app.includes("createDataChannel(\"oai-events\")")],
  ["Server-selected runtime", app.includes("status.runtime !== \"realtime\"") && !app.includes("localStorage.getItem(\"agrinexusRealtimeVoice\") === \"on\"")],
  ["One microphone owner protection", app.includes("stopNexusAudioFallbackRecorder(\"realtime-selected\")") && app.includes("stopNexusVoicePermissionStream(\"realtime-selected\")") && app.includes("voiceRecognition = null")],
  ...
  ["Blocked fallback truthful", app.includes("realtime-blocked") && app.includes("legacy fallback is blocked")],
...
console.log(JSON.stringify({
  ...
  groups,
  runtime: "server-selected realtime | legacy | disabled",
  selectedModelDefault: "gpt-realtime",
