...
assert(html.includes("nexus-behavior-234"), "Index must force latest learning functionality build");
assert(app.includes("nexus-behavior-234"), "App must expose latest learning functionality build");
assert(fs.readFileSync("public/sw.js", "utf8").includes("agrinexus-pwa-v214"), "Service worker cache must be bumped for learning functionality");
