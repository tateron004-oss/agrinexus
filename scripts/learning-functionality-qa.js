...
assert(html.includes("nexus-behavior-233"), "Index must force latest learning functionality build");
assert(app.includes("nexus-behavior-233"), "App must expose latest learning functionality build");
assert(fs.readFileSync("public/sw.js", "utf8").includes("agrinexus-pwa-v213"), "Service worker cache must be bumped for learning functionality");
