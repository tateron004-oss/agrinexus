...
assert(html.includes("nexus-behavior-267"), "Index must force latest learning functionality build");
assert(app.includes("nexus-behavior-267"), "App must expose latest learning functionality build");
assert(fs.readFileSync("public/sw.js", "utf8").includes("agrinexus-pwa-v247"), "Service worker cache must be bumped for learning functionality");
