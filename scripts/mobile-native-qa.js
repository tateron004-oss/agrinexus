...
const requirements = [
  ["native bridge contract", bridge.version === "1.1.0" && bridge.wakePhrases.includes("Agri") && bridge.requiredPermissions.includes("backgroundAudio") && bridge.webCommands.includes("voice.stop")],
  ...
  ["offline bridge cache", sw.includes("native-bridge.json") && sw.includes("agrinexus-pwa-v173")],
