...
assert(html.includes("nexus-behavior-77"), "Index must force browsers to load Nexus behavior CSS");
assert(html.includes("nexus-behavior-77"), "Index must force browsers to load Nexus behavior JS");
