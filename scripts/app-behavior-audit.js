...
assert(html.includes("nexus-behavior-146"), "Index must force browsers to load Nexus behavior CSS");
assert(html.includes("nexus-behavior-146"), "Index must force browsers to load Nexus behavior JS");
