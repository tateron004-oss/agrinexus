...
assert(html.includes("nexus-behavior-234"), "Index must force browsers to load Nexus behavior CSS");
assert(html.includes("nexus-behavior-234"), "Index must force browsers to load Nexus behavior JS");
