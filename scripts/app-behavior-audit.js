...
assert(html.includes("nexus-behavior-163"), "Index must force browsers to load Nexus behavior CSS");
assert(html.includes("nexus-behavior-163"), "Index must force browsers to load Nexus behavior JS");
