...
assert(app.includes("I heard you need clinic support."), "User clinic-near-me voice command should explain and guide clinic/mobile clinic/map support before provider routing");
