...
(async () => {
  ...
  const server = spawn(process.execPath, ["server.js"], {
    cwd: root,
    env: { ...process.env, NEXUS_PRESERVE_EMPTY_ENV: "1", PORT: String(port), AGRINEXUS_DB_PATH: tempDb, OPENAI_API_KEY: "", AGRINEXUS_RATE_LIMIT_PER_WINDOW: String(totalTarget + 500), AGRINEXUS_AI_AGENT_RATE_LIMIT_PER_WINDOW: String(totalTarget + 500) },
    stdio: "ignore",
    windowsHide: true
  });
