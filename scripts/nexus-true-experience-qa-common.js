...
function assertCacheResponsive() {
  assert(app.includes('const AGRINEXUS_BUILD_VERSION = "nexus-behavior-476"'), "app build version bumped");
  assert(app.includes('const AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v421"'), "app cache version bumped");
  assert(server.includes('const AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-476"'), "server build version bumped");
  assert(server.includes('const AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v421"'), "server cache version bumped");
  assert(sw.includes('const CACHE_NAME = "agrinexus-pwa-v421"'), "service worker cache version bumped");
