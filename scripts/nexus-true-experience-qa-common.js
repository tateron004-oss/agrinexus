...
function assertCacheResponsive() {
  assert(app.includes('const AGRINEXUS_BUILD_VERSION = "nexus-behavior-449"'), "app build version bumped");
  assert(app.includes('const AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v394"'), "app cache version bumped");
  assert(server.includes('const AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-449"'), "server build version bumped");
  assert(server.includes('const AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v394"'), "server cache version bumped");
  assert(sw.includes('const CACHE_NAME = "agrinexus-pwa-v394"'), "service worker cache version bumped");
