...
function assertCacheResponsive() {
  assert(app.includes('const AGRINEXUS_BUILD_VERSION = "nexus-behavior-463"'), "app build version bumped");
  assert(app.includes('const AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v408"'), "app cache version bumped");
  assert(server.includes('const AGRINEXUS_WEB_BUILD_VERSION = "nexus-behavior-463"'), "server build version bumped");
  assert(server.includes('const AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-v408"'), "server cache version bumped");
  assert(sw.includes('const CACHE_NAME = "agrinexus-pwa-v408"'), "service worker cache version bumped");
