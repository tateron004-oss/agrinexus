...
assert.match(server, /nexus-behavior-512/);
assert.match(app, /nexus-behavior-512/);
assert.match(html, /nexus-behavior-512/);
assert.match(sw, /nexus-behavior-512/);
assert.match(server, /agrinexus-pwa-v457/);
assert.match(app, /agrinexus-pwa-v457/);
assert.match(sw, /agrinexus-pwa-v457/);
