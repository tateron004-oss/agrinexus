...
assert.match(server, /nexus-behavior-506/);
assert.match(app, /nexus-behavior-506/);
assert.match(html, /nexus-behavior-506/);
assert.match(sw, /nexus-behavior-506/);
assert.match(server, /agrinexus-pwa-v451/);
assert.match(app, /agrinexus-pwa-v451/);
assert.match(sw, /agrinexus-pwa-v451/);
