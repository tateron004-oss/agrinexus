...
assert(!/controlledActionMetadata[\s\S]{0,220}(openWorkflow|goSection|mutate|request|confirm|execute|stage|modal|permission|getUserMedia|geolocation)/i.test(observationBody), "observation helper must not execute from controlled metadata");
