...
function selectIntent(goal = "") {
  ...
  if (hasAny(text, [/remind|reminder|check.*later/])) return { domain: "workflow", intent: "create_reminder", capabilityIds: ["workflow.reminder"], missingInformation: /tonight|tomorrow|later|today|next|morning|afternoon|evening|at \d/i.test(text) ? [] : ["reminder timing"], riskLevel: "low" };
