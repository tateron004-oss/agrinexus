  ...
  var require_router = __commonJS({
    "rebuild/nexus-core/router.js"(exports, module) {
      ...
      function routeCommand(command, connectionState) {
        ...
        const providerCardRequest = /\b(card|summary)\b.*\b(doctor|physician|provider|pharmacist)\b/i.test(normalized) || /\b(doctor|physician|provider|pharmacist)\b.*\b(card|summary)\b/i.test(normalized);
        const match = providerCardRequest ? ["health"] : ROUTES.find(([, pattern]) => pattern.test(normalized));
        return Object.freeze({
