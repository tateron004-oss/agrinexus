(function nexusContentPopulationExtension(globalObject) {
  ...
  function canonicalProtectedWorkspace(command) {
    ...
    if (/\b(picture|pictures|image|images|photo|photos)\b/.test(value) && /\b(maize|maized|maesd|maze|mage|mace|mase|mased|mays|disease|diseases|crop|plant|pest)\b/.test(value)) return "agriculture";
