...
assert.match(instructions, /follow-up requests to add, change, correct, read, review, save, reopen, restore, submit, or confirm/i);
assert.match(instructions, /handled by the visible form controller from the final transcript/i);
assert.match(instructions, /do not call route_nexus_command for those form follow-ups/i);
