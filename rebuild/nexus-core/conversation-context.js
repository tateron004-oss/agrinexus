...
const CONTEXTUAL_CUES = /\b(?:again|also|instead|next|previous|same|that|those|them|their|there|it|all of|whole of|go back|take me back|zoom|change|update|replace|make it|show me|open it|use that|use the|what about|how about|and then|now|tell me more|continue)\b/i;
const REFERENTIAL_CUES = /\b(?:again|instead|previous|same|that|those|them|their|there|it|what about|how about|use that|use the same)\b/i;
