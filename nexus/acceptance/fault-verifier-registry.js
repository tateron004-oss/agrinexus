...
const FAULT_VERIFIERS = Object.freeze({
  ...
  "exclusive-unified-ownership": nodeTest("test/nexus/system-convergence.test.js", "production exposes one authoritative durable runtime for all 21 workspaces", "all supported workspaces share one authoritative durable runtime"),
