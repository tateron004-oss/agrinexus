...
assert.strictEqual(
  ...
  "node archive/qa-scripts/nexus-enterprise-health-laboratory-diagnostic-governance-qa.js",
  "package alias exists"
);
includes(qaSuite, "archive/qa-scripts/nexus-enterprise-health-laboratory-diagnostic-governance-qa.js", "safe suites include laboratory/diagnostic QA");
