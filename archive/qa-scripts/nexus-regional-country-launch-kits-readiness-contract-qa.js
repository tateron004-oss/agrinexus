...
assert(packageData.scripts["qa:nexus-regional-country-launch-kits-readiness-contract"] === "node archive/qa-scripts/nexus-regional-country-launch-kits-readiness-contract-qa.js", "package.json must expose qa alias.");
assert(qaSuite.includes("archive/qa-scripts/nexus-regional-country-launch-kits-readiness-contract-qa.js"), "qa-suite.js must include Phase 98 QA.");
