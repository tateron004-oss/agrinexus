...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-32-follow-up-planning-qa.js"), "A100-32 QA must exist.");
  if (32 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-32-follow-up-planning"], "node archive/qa-scripts/nexus-a100-32-follow-up-planning-qa.js", "A100-32 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-32-follow-up-planning-qa.js"), "A100-32 QA must be wired into local-safe suites.");
}
