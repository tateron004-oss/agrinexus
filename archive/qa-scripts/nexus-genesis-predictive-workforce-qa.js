...
assert.strictEqual(
  ...
  "node archive/qa-scripts/nexus-genesis-predictive-workforce-qa.js",
  "package alias must run focused QA"
);
includes(qaSuite, "archive/qa-scripts/nexus-genesis-predictive-workforce-qa.js", "qa-suite wiring");
