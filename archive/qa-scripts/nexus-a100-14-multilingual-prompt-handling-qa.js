...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-14-multilingual-prompt-handling-qa.js"), "A100-14 QA must exist.");
  if (14 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-14-multilingual-prompt-handling"], "node archive/qa-scripts/nexus-a100-14-multilingual-prompt-handling-qa.js", "A100-14 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-14-multilingual-prompt-handling-qa.js"), "A100-14 QA must be wired into local-safe suites.");
}
