...
assert(exists("archive", "qa-scripts", qaName), "Sprint T5 QA script must exist.");
...
for (const requiredScript of requiredScripts) {
  assert(exists("archive", "qa-scripts", requiredScript), `Sprint T5 requires prior Sprint T QA: ${requiredScript}`);
...
assert.equal(
  pkg.scripts[alias],
  "node archive/qa-scripts/nexus-sprint-t5-healthcare-access-intelligence-lane-closeout-qa.js",
  "package.json must expose Sprint T5 QA alias."
);
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-t5-healthcare-access-intelligence-lane-closeout-qa.js"), "qa-suite must include Sprint T5 QA.");
