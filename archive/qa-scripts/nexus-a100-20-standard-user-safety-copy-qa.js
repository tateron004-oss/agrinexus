...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-20-standard-user-safety-copy-qa.js"), "A100-20 QA must exist.");
  if (20 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-20-standard-user-safety-copy"], "node archive/qa-scripts/nexus-a100-20-standard-user-safety-copy-qa.js", "A100-20 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-20-standard-user-safety-copy-qa.js"), "A100-20 QA must be wired into local-safe suites.");
}
