...
assert(exists("archive", "qa-scripts", qaName), "Sprint AC1 QA script must exist.");
...
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-ab5-mobile-clinic-mode-lane-closeout-qa.js"), "qa-suite must continue to include Sprint AB5 QA.");
assert(qaSuite.includes("archive/qa-scripts/nexus-transportation-mode-readiness-contract-qa.js"), "qa-suite must continue to include Phase 81 QA.");
