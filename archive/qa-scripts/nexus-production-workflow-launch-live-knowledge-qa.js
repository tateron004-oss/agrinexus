...
assert.strictEqual(
  ...
  "node archive/qa-scripts/nexus-production-workflow-launch-live-knowledge-qa.js",
  "package alias should run production workflow launch/live knowledge QA"
);
includes(qaSuite, "archive/qa-scripts/nexus-production-workflow-launch-live-knowledge-qa.js", "qa suite should include production workflow launch/live knowledge QA");
