...
assert.equal(
  ...
  "node archive/qa-scripts/nexus-capability-sprint-18-safety-review-dashboard-qa.js",
  "package alias should expose Sprint 18 QA."
);

assert(
  qaSuite.includes("archive/qa-scripts/nexus-capability-sprint-18-safety-review-dashboard-qa.js"),
