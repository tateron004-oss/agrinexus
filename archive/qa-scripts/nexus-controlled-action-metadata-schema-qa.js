...
assert.match(observationBody, /lowRiskSuggestion,[\s\S]{0,260}controlledActionMetadata/, "observation record should store controlled metadata beside low-risk suggestion");
