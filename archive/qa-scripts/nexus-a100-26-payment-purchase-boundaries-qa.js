...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-26-payment-purchase-boundaries-qa.js"), "A100-26 QA must exist.");
  if (26 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-26-payment-purchase-boundaries"], "node archive/qa-scripts/nexus-a100-26-payment-purchase-boundaries-qa.js", "A100-26 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-26-payment-purchase-boundaries-qa.js"), "A100-26 QA must be wired into local-safe suites.");
}
