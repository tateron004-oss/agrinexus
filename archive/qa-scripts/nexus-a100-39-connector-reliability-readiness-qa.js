...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-39-connector-reliability-readiness-qa.js"), "A100-39 QA must exist.");
  if (39 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-39-connector-reliability-readiness"], "node archive/qa-scripts/nexus-a100-39-connector-reliability-readiness-qa.js", "A100-39 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-39-connector-reliability-readiness-qa.js"), "A100-39 QA must be wired into local-safe suites.");
}
