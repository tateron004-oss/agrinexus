...
assert(exists("archive", "qa-scripts", qaName), "Sprint AB1 QA script must exist.");
...
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-aa5-pharmacy-mode-lane-closeout-qa.js"), "qa-suite must continue to include Sprint AA5 QA.");
assert(qaSuite.includes("archive/qa-scripts/nexus-mobile-clinic-mode-readiness-contract-qa.js"), "qa-suite must continue to include Phase 80 QA.");
