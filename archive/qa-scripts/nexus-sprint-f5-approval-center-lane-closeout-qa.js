...
assert(exists("archive", "qa-scripts", qaName), "Sprint F5 QA script must exist.");
...
const f3Harness = read("archive", "qa-scripts", "nexus-sprint-f3-approval-center-flag-contract-harness.js");
...
for (const requiredScript of requiredScripts) {
  assert(exists("archive", "qa-scripts", requiredScript), `Sprint F5 requires prior Sprint F QA: ${requiredScript}`);
