...
assert(packageData.scripts["qa:nexus-transportation-provider-connector-contract"] === "node archive/qa-scripts/nexus-transportation-provider-connector-contract-qa.js", "package.json must expose qa:nexus-transportation-provider-connector-contract");
assert(qaSuite.includes("archive/qa-scripts/nexus-transportation-provider-connector-contract-qa.js"), "qa-suite.js must include transportation provider connector contract QA");
