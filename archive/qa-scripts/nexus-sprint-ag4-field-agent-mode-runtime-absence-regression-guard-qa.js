...
assert(exists("archive", "qa-scripts", qaName), "Sprint AG4 QA script must exist.");
...
const ag3Harness = read("archive", "qa-scripts", "nexus-sprint-ag3-field-agent-mode-flag-contract-harness.js");
