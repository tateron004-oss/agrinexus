...
assert(packageJson.includes(`"qa:nexus-controlled-low-risk-renderer-mount-point-readiness-review-before-runtime-wiring": "node archive/qa-scripts/${scriptName}"`), "package.json must expose Phase 13K QA alias");
