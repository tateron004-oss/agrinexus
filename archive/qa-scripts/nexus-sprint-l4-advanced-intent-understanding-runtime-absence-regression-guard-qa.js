...
assert(exists("archive", "qa-scripts", qaName), "Sprint L4 QA script must exist.");
...
const harnessSource = read("archive", "qa-scripts", "nexus-sprint-l3-advanced-intent-understanding-flag-contract-harness.js");
