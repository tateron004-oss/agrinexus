...
assert(exists("archive", "qa-scripts", qaName), "Sprint AH4 QA script must exist.");
...
const ah3Harness = read("archive", "qa-scripts", "nexus-sprint-ah3-provider-mode-flag-contract-harness.js");
