...
assert(exists("archive", "qa-scripts", qaName), "O2 QA must exist.");
...
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-o1-payment-safety-product-boundary-qa.js"), "O2 requires O1 QA to remain in qa-suite.");
