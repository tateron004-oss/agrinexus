...
assert(exists("archive", "qa-scripts", qaName), "O6 QA must exist.");
...
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-o5-flag-off-payment-regression-qa.js"), "O6 requires O5 QA to remain in qa-suite.");
