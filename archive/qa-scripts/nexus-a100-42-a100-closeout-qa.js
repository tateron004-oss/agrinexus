...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-42-a100-closeout-qa.js"), "A100-42 QA must exist.");
  if (42 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-42-a100-closeout"], "node archive/qa-scripts/nexus-a100-42-a100-closeout-qa.js", "A100-42 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-42-a100-closeout-qa.js"), "A100-42 QA must be wired into local-safe suites.");
}
