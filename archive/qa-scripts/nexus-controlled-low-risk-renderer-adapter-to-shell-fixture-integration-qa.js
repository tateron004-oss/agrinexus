...
assert(packageJson.includes(`"qa:nexus-controlled-low-risk-renderer-adapter-to-shell-fixture-integration": "node archive/qa-scripts/${scriptName}"`), "package.json must expose Phase 13S QA alias");
