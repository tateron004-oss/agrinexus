...
assert(patcher.includes('archive/qa-scripts/nexus-phase-101-agriculture-support-response-card-runtime-qa.js'), "patcher must wire runtime QA script.");
assert(patcher.includes('archive/qa-scripts/nexus-phase-101b-standard-user-runtime-wiring-readiness-qa.js'), "patcher must wire readiness QA script.");
