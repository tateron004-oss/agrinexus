...
assert(exists("archive", "qa-scripts", qaName), "Sprint AE1 QA script must exist.");
...
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-ad5-workforce-mode-lane-closeout-qa.js"), "qa-suite must continue to include Sprint AD5 QA.");
