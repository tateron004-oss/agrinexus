...
assert.strictEqual(
  ...
  "node archive/qa-scripts/nexus-enterprise-health-model-source-monitoring-governance-qa.js",
  "package alias exists"
);
includes(qaSuite, "archive/qa-scripts/nexus-enterprise-health-model-source-monitoring-governance-qa.js", "safe suites include model/source monitoring QA");
