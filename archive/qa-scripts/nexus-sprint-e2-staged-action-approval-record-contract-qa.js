...
assert(exists("archive", "qa-scripts", qaName), "Sprint E2 QA script must exist.");
...
assert(exists("archive", "qa-scripts", "nexus-sprint-e1-staged-action-approval-audit-product-boundary-qa.js"), "E2 requires E1 QA.");
...
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-e1-staged-action-approval-audit-product-boundary-qa.js"), "E2 requires E1 QA to remain in qa-suite.");
