...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-24-location-permission-readiness-qa.js"), "A100-24 QA must exist.");
  if (24 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-24-location-permission-readiness"], "node archive/qa-scripts/nexus-a100-24-location-permission-readiness-qa.js", "A100-24 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-24-location-permission-readiness-qa.js"), "A100-24 QA must be wired into local-safe suites.");
}
