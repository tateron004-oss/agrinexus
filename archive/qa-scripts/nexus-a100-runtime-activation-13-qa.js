...
assert.equal(pkg.scripts["qa:nexus-a100-runtime-activation-13"], "node archive/qa-scripts/nexus-a100-runtime-activation-13-qa.js", "Sprint 13 QA alias should exist.");
assert(qaSuite.includes("archive/qa-scripts/nexus-a100-runtime-activation-13-qa.js"), "Sprint 13 QA should be wired into qa-suite.");
