...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-28-offline-low-bandwidth-readiness-qa.js"), "A100-28 QA must exist.");
  if (28 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-28-offline-low-bandwidth-readiness"], "node archive/qa-scripts/nexus-a100-28-offline-low-bandwidth-readiness-qa.js", "A100-28 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-28-offline-low-bandwidth-readiness-qa.js"), "A100-28 QA must be wired into local-safe suites.");
}
