...
assert(exists("archive", "qa-scripts", harnessName), "Sprint G7 harness must exist.");
assert(exists("archive", "qa-scripts", qaName), "Sprint G7 QA must exist.");
...
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-g6-provider-dispatch-dry-run-contract-qa.js"), "G7 requires G6 QA to remain in qa-suite.");
