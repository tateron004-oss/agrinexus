...
assert(count(renderUserWorkspace, 'data-nexus-standard-user-render-root="true-conversational-experience"') === 1, "true conversational root owns the Standard User render root");
...
assert(!renderUserWorkspace.includes('renderNexusUserWorkspaceSegment("Review workspace details", renderNexusOsDeferredLegacySurfaces)'), "legacy tools are not mounted on the true conversational startup");
...
assert(packageJson.scripts["qa:nexus-experience-render-root"] === "node archive/qa-scripts/nexus-experience-render-root-qa.js", "package alias exists");
assert(qaSuite.includes("archive/qa-scripts/nexus-experience-render-root-qa.js"), "safe QA suite includes render root QA");
