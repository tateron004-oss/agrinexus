...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-33-risk-confidence-labels-qa.js"), "A100-33 QA must exist.");
  if (33 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-33-risk-confidence-labels"], "node archive/qa-scripts/nexus-a100-33-risk-confidence-labels-qa.js", "A100-33 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-33-risk-confidence-labels-qa.js"), "A100-33 QA must be wired into local-safe suites.");
}
