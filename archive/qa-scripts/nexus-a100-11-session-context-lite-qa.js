...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-11-session-context-lite-qa.js"), "A100-11 QA must exist.");
  if (11 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-11-session-context-lite"], "node archive/qa-scripts/nexus-a100-11-session-context-lite-qa.js", "A100-11 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-11-session-context-lite-qa.js"), "A100-11 QA must be wired into local-safe suites.");
}
