...
assert(packageJson.includes(`"qa:nexus-controlled-low-risk-renderer-final-standard-user-browser-validation-default-off": "node archive/qa-scripts/${scriptName}"`), "package.json must expose Phase 13W QA alias");
