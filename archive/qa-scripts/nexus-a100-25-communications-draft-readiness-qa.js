...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-25-communications-draft-readiness-qa.js"), "A100-25 QA must exist.");
  if (25 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-25-communications-draft-readiness"], "node archive/qa-scripts/nexus-a100-25-communications-draft-readiness-qa.js", "A100-25 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-25-communications-draft-readiness-qa.js"), "A100-25 QA must be wired into local-safe suites.");
}
