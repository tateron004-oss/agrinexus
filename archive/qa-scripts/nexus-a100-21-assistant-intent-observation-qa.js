...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-21-assistant-intent-observation-qa.js"), "A100-21 QA must exist.");
  if (21 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-21-assistant-intent-observation"], "node archive/qa-scripts/nexus-a100-21-assistant-intent-observation-qa.js", "A100-21 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-21-assistant-intent-observation-qa.js"), "A100-21 QA must be wired into local-safe suites.");
}
