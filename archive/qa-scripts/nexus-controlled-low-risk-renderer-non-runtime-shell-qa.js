...
assert(packageJson.includes(`"qa:nexus-controlled-low-risk-renderer-non-runtime-shell": "node archive/qa-scripts/${scriptName}"`), "package.json must expose Phase 13P QA alias");
