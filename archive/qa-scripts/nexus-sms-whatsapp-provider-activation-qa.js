...
assert(server.includes("let recipient = contact.to || ownerTestRecipient"), "Realtime communications should prefer a spoken recipient and safely fall back to the explicitly requested owner test recipient");
