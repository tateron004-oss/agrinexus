...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-18-provider-availability-fallbacks-qa.js"), "A100-18 QA must exist.");
  if (18 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-18-provider-availability-fallbacks"], "node archive/qa-scripts/nexus-a100-18-provider-availability-fallbacks-qa.js", "A100-18 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-18-provider-availability-fallbacks-qa.js"), "A100-18 QA must be wired into local-safe suites.");
}
