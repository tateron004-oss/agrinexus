...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-15-qa-hardening-qa.js"), "A100-15 QA must exist.");
  if (15 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-15-qa-hardening"], "node archive/qa-scripts/nexus-a100-15-qa-hardening-qa.js", "A100-15 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-15-qa-hardening-qa.js"), "A100-15 QA must be wired into local-safe suites.");
}
