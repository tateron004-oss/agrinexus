...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-16-runtime-readiness-closeout-qa.js"), "A100-16 QA must exist.");
  if (16 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-16-runtime-readiness-closeout"], "node archive/qa-scripts/nexus-a100-16-runtime-readiness-closeout-qa.js", "A100-16 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-16-runtime-readiness-closeout-qa.js"), "A100-16 QA must be wired into local-safe suites.");
}
