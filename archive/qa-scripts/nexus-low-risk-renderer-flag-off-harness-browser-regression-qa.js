...
assert(suite.includes("archive/qa-scripts/nexus-low-risk-renderer-flag-off-harness-browser-regression-qa.js"), "nexus-workforce suite must include Phase 12U browser regression QA");
