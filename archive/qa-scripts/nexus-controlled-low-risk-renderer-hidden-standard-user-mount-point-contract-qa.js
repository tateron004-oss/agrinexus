...
assert(packageJson.includes(`"qa:nexus-controlled-low-risk-renderer-hidden-standard-user-mount-point-contract": "node archive/qa-scripts/${scriptName}"`), "package.json must expose Phase 13H QA alias");
