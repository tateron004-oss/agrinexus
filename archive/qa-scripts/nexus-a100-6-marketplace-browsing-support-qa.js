...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-6-marketplace-browsing-support-qa.js"), "A100-6 QA must exist.");
  if (6 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-6-marketplace-browsing-support"], "node archive/qa-scripts/nexus-a100-6-marketplace-browsing-support-qa.js", "A100-6 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-6-marketplace-browsing-support-qa.js"), "A100-6 QA must be wired into local-safe suites.");
}
