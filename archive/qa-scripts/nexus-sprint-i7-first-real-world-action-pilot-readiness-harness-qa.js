...
assert(exists("archive", "qa-scripts", harnessName), "Sprint I7 harness must exist.");
assert(exists("archive", "qa-scripts", qaName), "Sprint I7 QA must exist.");
...
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-i6-first-real-world-action-pilot-readiness-contract-qa.js"), "I7 requires I6 QA to remain in qa-suite.");
