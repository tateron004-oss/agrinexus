...
assert(exists("archive", "qa-scripts", harnessName), "Sprint AG3 harness script must exist.");
assert(exists("archive", "qa-scripts", qaName), "Sprint AG3 QA script must exist.");
...
assert(qaSuite.includes("archive/qa-scripts/nexus-field-agent-mode-readiness-contract-qa.js"), "qa-suite must continue to include Field Agent Mode readiness QA.");
