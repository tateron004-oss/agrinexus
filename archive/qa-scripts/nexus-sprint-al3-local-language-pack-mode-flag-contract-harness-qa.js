...
assert(exists("archive", "qa-scripts", harnessName), "Sprint AL3 harness script must exist.");
assert(exists("archive", "qa-scripts", qaName), "Sprint AL3 QA script must exist.");
