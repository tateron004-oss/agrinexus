...
assert.strictEqual(
  ...
  "node archive/qa-scripts/nexus-enterprise-health-accessibility-localization-governance-qa.js",
  "package alias exists"
);
includes(qaSuite, "archive/qa-scripts/nexus-enterprise-health-accessibility-localization-governance-qa.js", "safe suites include accessibility/localization QA");
