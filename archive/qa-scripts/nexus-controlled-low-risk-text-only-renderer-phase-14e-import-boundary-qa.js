...
assert(packageJson.scripts["qa:nexus-controlled-low-risk-text-only-renderer-phase-14e-import-boundary"] === "node archive/qa-scripts/nexus-controlled-low-risk-text-only-renderer-phase-14e-import-boundary-qa.js", "package.json must expose Phase 14E QA alias.");
...
assert(qaSuite.includes("archive/qa-scripts/nexus-controlled-low-risk-text-only-renderer-phase-14c-test-harness-qa.js"), "nexus-workforce suite must retain Phase 14C QA.");
assert(qaSuite.includes("archive/qa-scripts/nexus-controlled-low-risk-text-only-renderer-phase-14d-runtime-loader-stub-qa.js"), "nexus-workforce suite must retain Phase 14D QA.");
assert(qaSuite.includes("archive/qa-scripts/nexus-controlled-low-risk-text-only-renderer-phase-14e-import-boundary-qa.js"), "nexus-workforce suite must include Phase 14E QA.");
