...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-2-low-risk-task-cards-qa.js"), "A100-2 QA must exist.");
  if (2 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-2-low-risk-task-cards"], "node archive/qa-scripts/nexus-a100-2-low-risk-task-cards-qa.js", "A100-2 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-2-low-risk-task-cards-qa.js"), "A100-2 QA must be wired into local-safe suites.");
}
