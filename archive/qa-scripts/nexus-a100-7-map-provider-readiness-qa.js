...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-7-map-provider-readiness-qa.js"), "A100-7 QA must exist.");
  if (7 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-7-map-provider-readiness"], "node archive/qa-scripts/nexus-a100-7-map-provider-readiness-qa.js", "A100-7 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-7-map-provider-readiness-qa.js"), "A100-7 QA must be wired into local-safe suites.");
}
