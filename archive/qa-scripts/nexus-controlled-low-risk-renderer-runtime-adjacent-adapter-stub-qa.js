...
assert(packageJson.includes(`"qa:nexus-controlled-low-risk-renderer-runtime-adjacent-adapter-stub": "node archive/qa-scripts/${scriptName}"`), "package.json must expose Phase 13T QA alias");
