...
assert(exists("archive", "qa-scripts", qaName), "Sprint U5 QA script must exist.");
...
const u3Harness = read("archive", "qa-scripts", "nexus-sprint-u3-workforce-intelligence-flag-contract-harness.js");
...
for (const requiredScript of requiredScripts) {
  assert(exists("archive", "qa-scripts", requiredScript), `Sprint U5 requires prior Sprint U QA: ${requiredScript}`);
...
assert.equal(
  pkg.scripts[alias],
  "node archive/qa-scripts/nexus-sprint-u5-workforce-intelligence-lane-closeout-qa.js",
  "package.json must expose Sprint U5 QA alias."
);
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-u5-workforce-intelligence-lane-closeout-qa.js"), "qa-suite must include Sprint U5 QA.");
