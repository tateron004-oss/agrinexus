...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-40-stale-data-alert-readiness-qa.js"), "A100-40 QA must exist.");
  if (40 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-40-stale-data-alert-readiness"], "node archive/qa-scripts/nexus-a100-40-stale-data-alert-readiness-qa.js", "A100-40 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-40-stale-data-alert-readiness-qa.js"), "A100-40 QA must be wired into local-safe suites.");
}
