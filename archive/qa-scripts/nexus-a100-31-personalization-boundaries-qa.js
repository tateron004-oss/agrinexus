...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-31-personalization-boundaries-qa.js"), "A100-31 QA must exist.");
  if (31 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-31-personalization-boundaries"], "node archive/qa-scripts/nexus-a100-31-personalization-boundaries-qa.js", "A100-31 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-31-personalization-boundaries-qa.js"), "A100-31 QA must be wired into local-safe suites.");
}
