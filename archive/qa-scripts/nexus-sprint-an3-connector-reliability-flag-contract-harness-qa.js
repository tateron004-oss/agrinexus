...
assert(exists("archive", "qa-scripts", harnessName), "Sprint AN3 harness script must exist.");
assert(exists("archive", "qa-scripts", qaName), "Sprint AN3 QA script must exist.");
