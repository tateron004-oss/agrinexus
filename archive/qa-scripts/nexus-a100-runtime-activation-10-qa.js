...
assert.equal(pkg.scripts["qa:nexus-a100-runtime-activation-10"], "node archive/qa-scripts/nexus-a100-runtime-activation-10-qa.js", "Sprint 10 QA alias should exist.");
assert(qaSuite.includes("archive/qa-scripts/nexus-a100-runtime-activation-10-qa.js"), "Sprint 10 QA should be wired into qa-suite.");
