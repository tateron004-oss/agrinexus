...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-5-workforce-jobs-support-qa.js"), "A100-5 QA must exist.");
  if (5 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-5-workforce-jobs-support"], "node archive/qa-scripts/nexus-a100-5-workforce-jobs-support-qa.js", "A100-5 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-5-workforce-jobs-support-qa.js"), "A100-5 QA must be wired into local-safe suites.");
}
