...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-13-high-risk-gating-qa.js"), "A100-13 QA must exist.");
  if (13 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-13-high-risk-gating"], "node archive/qa-scripts/nexus-a100-13-high-risk-gating-qa.js", "A100-13 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-13-high-risk-gating-qa.js"), "A100-13 QA must be wired into local-safe suites.");
}
