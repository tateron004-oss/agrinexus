...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-9-provider-status-surfaces-qa.js"), "A100-9 QA must exist.");
  if (9 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-9-provider-status-surfaces"], "node archive/qa-scripts/nexus-a100-9-provider-status-surfaces-qa.js", "A100-9 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-9-provider-status-surfaces-qa.js"), "A100-9 QA must be wired into local-safe suites.");
}
