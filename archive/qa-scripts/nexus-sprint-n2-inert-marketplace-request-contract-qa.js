...
assert(exists("archive", "qa-scripts", qaName), "N2 QA must exist.");
...
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-n1-marketplace-request-product-boundary-qa.js"), "N2 requires N1 QA to remain in qa-suite.");
