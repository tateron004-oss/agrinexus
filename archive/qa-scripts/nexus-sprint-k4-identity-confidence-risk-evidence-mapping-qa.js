...
assert(exists("archive", "qa-scripts", qaName), "K4 QA must exist.");
...
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-k3-contact-provider-identity-harness-qa.js"), "K4 requires K3 QA to remain in qa-suite.");
