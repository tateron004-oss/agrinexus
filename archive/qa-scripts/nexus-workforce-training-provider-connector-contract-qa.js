...
assert(packageData.scripts["qa:nexus-workforce-training-provider-connector-contract"] === "node archive/qa-scripts/nexus-workforce-training-provider-connector-contract-qa.js", "package.json must expose qa:nexus-workforce-training-provider-connector-contract");
assert(qaSuite.includes("archive/qa-scripts/nexus-workforce-training-provider-connector-contract-qa.js"), "qa-suite.js must include workforce training provider connector contract QA");
