...
assert.equal(
  ...
  "node archive/qa-scripts/nexus-capability-sprint-12-marketplace-inquiry-preparation-qa.js",
  "package alias should expose Sprint 12 QA."
);
assert(
  qaSuite.includes("archive/qa-scripts/nexus-capability-sprint-12-marketplace-inquiry-preparation-qa.js"),
