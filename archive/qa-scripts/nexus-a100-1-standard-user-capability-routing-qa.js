...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-1-standard-user-capability-routing-qa.js"), "A100-1 QA must exist.");
  if (1 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-1-standard-user-capability-routing"], "node archive/qa-scripts/nexus-a100-1-standard-user-capability-routing-qa.js", "A100-1 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-1-standard-user-capability-routing-qa.js"), "A100-1 QA must be wired into local-safe suites.");
}
