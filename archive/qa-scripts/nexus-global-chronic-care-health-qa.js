...
[
  ...
  "Emergency Boundary",
  "Health Review Queue",
  "Nexus, check provider submission readiness.",
  "Nexus, check RPM RTM connector readiness.",
  "Nexus, check medication pharmacy boundary.",
  "Nexus, show emergency boundary.",
  "Nexus, queue health review.",
  "data-testid=\"nexus-chronic-care-health-sections-gates\"",
  "will not diagnose, prescribe, change medication, submit records, contact providers, activate live RPM/RTM monitoring, execute pharmacy workflows, or dispatch emergency help",
...
assert.strictEqual(
  ...
  "node archive/qa-scripts/nexus-global-chronic-care-health-qa.js",
  "package script should expose global chronic-care health QA"
);
includes(qaSuite, "archive/qa-scripts/nexus-global-chronic-care-health-qa.js", "qa suite should include global chronic-care health QA");
