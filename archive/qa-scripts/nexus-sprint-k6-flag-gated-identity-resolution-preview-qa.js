...
assert(exists("archive", "qa-scripts", qaName), "K6 QA must exist.");
...
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-k5-flag-off-identity-resolution-regression-guard-qa.js"), "K6 requires K5 QA to remain in qa-suite.");
