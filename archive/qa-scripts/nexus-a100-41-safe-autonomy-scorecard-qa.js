...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-41-safe-autonomy-scorecard-qa.js"), "A100-41 QA must exist.");
  if (41 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-41-safe-autonomy-scorecard"], "node archive/qa-scripts/nexus-a100-41-safe-autonomy-scorecard-qa.js", "A100-41 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-41-safe-autonomy-scorecard-qa.js"), "A100-41 QA must be wired into local-safe suites.");
}
