...
assert(hero.includes("Enable voice once, then continue by speaking. Structured fields appear only when a workflow needs them."), "voice hint keeps typed fallback visible");
