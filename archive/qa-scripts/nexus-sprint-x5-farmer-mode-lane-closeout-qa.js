...
assert(exists("archive", "qa-scripts", qaName), "Sprint X5 QA script must exist.");
...
const x3Harness = read("archive", "qa-scripts", "nexus-sprint-x3-farmer-mode-flag-contract-harness.js");
...
for (const requiredScript of requiredScripts) {
  assert(exists("archive", "qa-scripts", requiredScript), `Sprint X5 requires prior Sprint X QA: ${requiredScript}`);
...
assert.equal(
  pkg.scripts[alias],
  "node archive/qa-scripts/nexus-sprint-x5-farmer-mode-lane-closeout-qa.js",
  "package.json must expose Sprint X5 QA alias."
);
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-x5-farmer-mode-lane-closeout-qa.js"), "qa-suite must include Sprint X5 QA.");
