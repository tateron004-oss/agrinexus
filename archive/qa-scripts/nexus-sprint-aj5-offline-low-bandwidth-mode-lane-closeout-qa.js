...
assert(exists("archive", "qa-scripts", qaName), "Sprint AJ5 QA script must exist.");
...
const harness = read("archive", "qa-scripts", "nexus-sprint-aj3-offline-low-bandwidth-mode-flag-contract-harness.js");
...
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-aj4-offline-low-bandwidth-mode-runtime-absence-regression-guard-qa.js"), "qa-suite must continue to include Sprint AJ4 QA.");
