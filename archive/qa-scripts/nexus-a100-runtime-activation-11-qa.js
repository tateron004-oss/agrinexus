...
assert.equal(pkg.scripts["qa:nexus-a100-runtime-activation-11"], "node archive/qa-scripts/nexus-a100-runtime-activation-11-qa.js", "Sprint 11 QA alias should exist.");
assert(qaSuite.includes("archive/qa-scripts/nexus-a100-runtime-activation-11-qa.js"), "Sprint 11 QA should be wired into qa-suite.");
