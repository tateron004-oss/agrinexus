...
assert.strictEqual(
  ...
  "node archive/qa-scripts/nexus-enterprise-health-security-privacy-adversarial-qa.js",
  "package alias exists"
);
includes(qaSuite, "archive/qa-scripts/nexus-enterprise-health-security-privacy-adversarial-qa.js", "safe suites include validation QA");
