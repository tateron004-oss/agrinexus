...
assert(packageData.scripts["qa:nexus-phase-105-preview-only-autonomous-runtime-integration-plan"] === "node archive/qa-scripts/nexus-phase-105-preview-only-autonomous-runtime-integration-plan-qa.js", "package alias must exist.");
assert(qaSuite.includes("archive/qa-scripts/nexus-phase-105-preview-only-autonomous-runtime-integration-plan-qa.js"), "qa-suite must include Phase 105 QA.");
