...
const paths = {
  ...
  phase14jQa: path.join(root, "archive", "qa-scripts", "nexus-controlled-low-risk-renderer-phase-14j-candidate-payload-contract-qa.js")
};
...
assert(packageJson.scripts[qaAlias] === `node archive/qa-scripts/${qaScriptName}`, "package.json must expose Phase 14K QA alias.");
