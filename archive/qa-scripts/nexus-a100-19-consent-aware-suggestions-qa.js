...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-19-consent-aware-suggestions-qa.js"), "A100-19 QA must exist.");
  if (19 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-19-consent-aware-suggestions"], "node archive/qa-scripts/nexus-a100-19-consent-aware-suggestions-qa.js", "A100-19 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-19-consent-aware-suggestions-qa.js"), "A100-19 QA must be wired into local-safe suites.");
}
