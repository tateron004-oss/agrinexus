...
assert(exists("archive", "qa-scripts", qaName), "Sprint AA5 QA script must exist.");
...
const aa3Harness = read("archive", "qa-scripts", "nexus-sprint-aa3-pharmacy-mode-flag-contract-harness.js");
...
for (const requiredScript of requiredScripts) {
  assert(exists("archive", "qa-scripts", requiredScript), `Sprint AA5 requires prior Sprint AA QA: ${requiredScript}`);
...
assert.equal(
  pkg.scripts[alias],
  "node archive/qa-scripts/nexus-sprint-aa5-pharmacy-mode-lane-closeout-qa.js",
  "package.json must expose Sprint AA5 QA alias."
);
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-aa5-pharmacy-mode-lane-closeout-qa.js"), "qa-suite must include Sprint AA5 QA.");
