...
assert(suite.includes("archive/qa-scripts/nexus-low-risk-renderer-controlled-runtime-flag-on-test-harness-implementation-qa.js"), "nexus-workforce suite must include Phase 12Y implementation QA");
assert(suite.includes("archive/qa-scripts/nexus-low-risk-renderer-controlled-runtime-flag-on-readiness-review-qa.js"), "nexus-workforce suite must keep Phase 12X readiness review QA");
assert(suite.includes("archive/qa-scripts/nexus-low-risk-renderer-controlled-runtime-flag-on-static-qa.js"), "nexus-workforce suite must keep Phase 12W static QA");
