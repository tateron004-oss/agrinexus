...
assert(exists("archive", "qa-scripts", qaName), "Sprint AK5 QA script must exist.");
...
const harness = read("archive", "qa-scripts", "nexus-sprint-ak3-africa-regional-deployment-mode-flag-contract-harness.js");
...
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-ak3-africa-regional-deployment-mode-flag-contract-harness-qa.js"), "qa-suite must continue to include Sprint AK3 QA.");
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-ak4-africa-regional-deployment-mode-runtime-absence-regression-guard-qa.js"), "qa-suite must continue to include Sprint AK4 QA.");
assert(qaSuite.includes("archive/qa-scripts/nexus-africa-regional-deployment-mode-readiness-contract-qa.js"), "qa-suite must continue to include Phase 89 QA.");
