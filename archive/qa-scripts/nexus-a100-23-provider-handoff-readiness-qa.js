...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-23-provider-handoff-readiness-qa.js"), "A100-23 QA must exist.");
  if (23 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-23-provider-handoff-readiness"], "node archive/qa-scripts/nexus-a100-23-provider-handoff-readiness-qa.js", "A100-23 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-23-provider-handoff-readiness-qa.js"), "A100-23 QA must be wired into local-safe suites.");
}
