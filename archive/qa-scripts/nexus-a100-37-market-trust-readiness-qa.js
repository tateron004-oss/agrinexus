...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-37-market-trust-readiness-qa.js"), "A100-37 QA must exist.");
  if (37 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-37-market-trust-readiness"], "node archive/qa-scripts/nexus-a100-37-market-trust-readiness-qa.js", "A100-37 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-37-market-trust-readiness-qa.js"), "A100-37 QA must be wired into local-safe suites.");
}
