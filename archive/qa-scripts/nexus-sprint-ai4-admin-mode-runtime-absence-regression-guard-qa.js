...
assert(exists("archive", "qa-scripts", qaName), "Sprint AI4 QA script must exist.");
...
const ai3Harness = read("archive", "qa-scripts", "nexus-sprint-ai3-admin-mode-flag-contract-harness.js");
