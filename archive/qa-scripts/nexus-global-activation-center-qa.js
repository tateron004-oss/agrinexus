...
assert.strictEqual(
  ...
  "node archive/qa-scripts/nexus-global-activation-center-qa.js",
  "package script should expose global activation center QA"
);
includes(qaSuite, "archive/qa-scripts/nexus-global-activation-center-qa.js", "qa suite should include global activation center QA");
