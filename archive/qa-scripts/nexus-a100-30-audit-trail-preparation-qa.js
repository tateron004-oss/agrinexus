...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-30-audit-trail-preparation-qa.js"), "A100-30 QA must exist.");
  if (30 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-30-audit-trail-preparation"], "node archive/qa-scripts/nexus-a100-30-audit-trail-preparation-qa.js", "A100-30 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-30-audit-trail-preparation-qa.js"), "A100-30 QA must be wired into local-safe suites.");
}
