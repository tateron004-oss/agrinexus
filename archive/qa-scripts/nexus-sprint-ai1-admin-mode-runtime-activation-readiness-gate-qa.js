...
assert(exists("archive", "qa-scripts", qaName), "Sprint AI1 QA script must exist.");
...
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-ah5-provider-mode-lane-closeout-qa.js"), "qa-suite must continue to include Sprint AH5 QA.");
