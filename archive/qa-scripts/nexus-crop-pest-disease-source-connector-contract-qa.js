...
assert(packageData.scripts["qa:nexus-crop-pest-disease-source-connector-contract"] === "node archive/qa-scripts/nexus-crop-pest-disease-source-connector-contract-qa.js", "package.json must expose qa:nexus-crop-pest-disease-source-connector-contract");
assert(qaSuite.includes("archive/qa-scripts/nexus-crop-pest-disease-source-connector-contract-qa.js"), "qa-suite.js must include crop pest disease source connector contract QA");
