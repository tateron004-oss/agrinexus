...
assert(exists("archive", "qa-scripts", qaName), "L6 QA must exist.");
...
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-l5-flag-off-calls-messaging-regression-guard-qa.js"), "L6 requires L5 QA to remain in qa-suite.");
