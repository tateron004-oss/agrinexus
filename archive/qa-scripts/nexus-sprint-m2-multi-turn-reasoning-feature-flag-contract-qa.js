...
assert(exists("archive", "qa-scripts", qaName), "Sprint M2 QA script must exist.");
...
assert(qaSuite.includes("archive/qa-scripts/nexus-sprint-m1-multi-turn-reasoning-runtime-activation-readiness-gate-qa.js"), "qa-suite must continue to include Sprint M1 QA.");
