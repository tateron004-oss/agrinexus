...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-3-agriculture-support-qa.js"), "A100-3 QA must exist.");
  if (3 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-3-agriculture-support"], "node archive/qa-scripts/nexus-a100-3-agriculture-support-qa.js", "A100-3 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-3-agriculture-support-qa.js"), "A100-3 QA must be wired into local-safe suites.");
}
