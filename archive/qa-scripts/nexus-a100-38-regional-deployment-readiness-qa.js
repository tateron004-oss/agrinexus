...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-38-regional-deployment-readiness-qa.js"), "A100-38 QA must exist.");
  if (38 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-38-regional-deployment-readiness"], "node archive/qa-scripts/nexus-a100-38-regional-deployment-readiness-qa.js", "A100-38 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-38-regional-deployment-readiness-qa.js"), "A100-38 QA must be wired into local-safe suites.");
}
