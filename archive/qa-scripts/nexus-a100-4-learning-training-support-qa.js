...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-4-learning-training-support-qa.js"), "A100-4 QA must exist.");
  if (4 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-4-learning-training-support"], "node archive/qa-scripts/nexus-a100-4-learning-training-support-qa.js", "A100-4 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-4-learning-training-support-qa.js"), "A100-4 QA must be wired into local-safe suites.");
}
