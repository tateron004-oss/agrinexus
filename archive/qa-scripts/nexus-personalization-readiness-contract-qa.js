...
assert(packageData.scripts["qa:nexus-personalization-readiness-contract"] === "node archive/qa-scripts/nexus-personalization-readiness-contract-qa.js", "package.json must expose qa:nexus-personalization-readiness-contract.");
assert(qaSuite.includes("archive/qa-scripts/nexus-personalization-readiness-contract-qa.js"), "qa-suite.js must include personalization readiness QA.");
