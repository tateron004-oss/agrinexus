...
const checks = [
  [
    ...
    app.includes('const AGRINEXUS_BUILD_VERSION = "__NEXUS_RELEASE_SHA__"') &&
      app.includes('const AGRINEXUS_PWA_CACHE_VERSION = "agrinexus-pwa-__NEXUS_RELEASE_SHA__"') &&
      server.includes("const AGRINEXUS_WEB_BUILD_VERSION = NEXUS_EFFECTIVE_RELEASE_SHA") &&
      sw.includes('const CACHE_NAME = "agrinexus-pwa-__NEXUS_RELEASE_SHA__"') &&
      index.includes("/app.js?v=__NEXUS_RELEASE_SHA__")
  ],
  [
    ...
    index.includes('id="nexusPermanentMicrophoneDock"') &&
      ...
      index.indexOf('id="nexusPermanentMicrophoneBtn"') < index.indexOf('/app.js?v=__NEXUS_RELEASE_SHA__') &&
