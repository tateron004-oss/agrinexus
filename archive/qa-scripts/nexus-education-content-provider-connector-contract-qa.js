...
assert(packageData.scripts["qa:nexus-education-content-provider-connector-contract"] === "node archive/qa-scripts/nexus-education-content-provider-connector-contract-qa.js", "package.json must expose qa:nexus-education-content-provider-connector-contract");
assert(qaSuite.includes("archive/qa-scripts/nexus-education-content-provider-connector-contract-qa.js"), "qa-suite.js must include education content provider connector contract QA");
