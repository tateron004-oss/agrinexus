...
function assertStaticSafety() {
  ...
  assert(exists("archive", "qa-scripts", "nexus-a100-27-health-access-preparation-qa.js"), "A100-27 QA must exist.");
  if (27 === 1) {
  ...
  assert.equal(pkg.scripts["qa:nexus-a100-27-health-access-preparation"], "node archive/qa-scripts/nexus-a100-27-health-access-preparation-qa.js", "A100-27 package QA alias must exist.");
  assert(qaSuite.includes("archive/qa-scripts/nexus-a100-27-health-access-preparation-qa.js"), "A100-27 QA must be wired into local-safe suites.");
}
