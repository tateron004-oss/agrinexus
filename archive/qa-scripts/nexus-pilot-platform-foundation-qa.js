...
assert.strictEqual(
  ...
  "node archive/qa-scripts/nexus-pilot-platform-foundation-qa.js",
  "package alias should run pilot platform foundation QA"
);
includes(qaSuite, "archive/qa-scripts/nexus-pilot-platform-foundation-qa.js", "safe QA suite wiring");
